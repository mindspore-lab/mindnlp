...
MODEL_PATH = "/home/daiyuxin/neoming_convbert/dev/mindnlp/llm/parallel/convbert/.mindnlp/model/YituTech/conv-bert-base"
...
def main(args):
    ...
    model = MSConvBertForQuestionAnswering.from_pretrained(args.model_name_or_path)
    ...
    # for input_ids, token_type_ids, attention_mask, start_positions, end_positions in ds:
    #     output = model(
    #         input_ids=input_ids,
    #         attention_mask=attention_mask,
    #         token_type_ids=token_type_ids,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_dir", type=str, default="convbert_lora_peft")
