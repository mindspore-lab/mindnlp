...
r"""
Module ``mindtorch.distributed.launch``.

``mindtorch.distributed.launch`` is a module that spawns up multiple distributed
...
::
    ...
    python -m mindtorch.distributed.launch --nproc-per-node=NUM_GPUS_YOU_HAVE
...
::
    ...
    python -m mindtorch.distributed.launch --help
...
::
    ...
    >>> mindtorch.cuda.set_device(args.local_rank)  # before your code runs

or

::

    >>> with mindtorch.cuda.device(args.local_rank):
    >>>    # your code to run
    >>>    ...
...
::
    ...
    >>> mindtorch.distributed.init_process_group(backend='YOUR BACKEND',
    >>>                                      init_method='env://')
...
from mindtorch.distributed.run import get_args_parser, run
...
@_deprecated(
    "The module mindtorch.distributed.launch is deprecated\n"
    "and will be removed in future. Use torchrun.\n"
    "Note that --use-env is set by default in torchrun.\n"
    "If your script expects `--local-rank` argument to be set, please\n"
    "change it to read from `os.environ['LOCAL_RANK']` instead. See \n"
    "https://pymindtorch.org/docs/stable/distributed.html#launch-utility for \n"
