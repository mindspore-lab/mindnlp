...
class MixedPrecisionPolicy:
    ...
    Attributes:
        param_dtype (Optional[mindtorch.dtype]): This specifies the dtype for
        ...
        reduce_dtype (Optional[mindtorch.dtype]): This specifies the dtype for
            ...
            (Default: ``None``)
        output_dtype (Optional[mindtorch.dtype]): This specifies the dtype for
    ...
    output_dtype: Optional[mindtorch.dtype] = None
