...
from mindtorch.distributed._composable.contract import contract
from mindtorch.distributed._composable_state import _get_module_state, _insert_module_state
from mindtorch.distributed.fsdp._common_utils import _FSDPState
...
from mindtorch.distributed.fsdp._state_dict_utils import _register_all_state_dict_hooks
...
@deprecated(
    "`mindtorch.distributed._composable.fully_shard` is being deprecated. "
    ...
    "`mindtorch.distributed._composable.fully_shard` will be removed after PyTorch 2.5. "
    "If you are looking for FSDP2, please see `mindtorch.distributed._composable.fsdp.fully_shard.`",
...
def fully_shard(
    ...
    *,
    ...
    mindtorch._C._log_api_usage_once("mindtorch.distributed.fully_shard")
