...
class ShardedOptimizer(optim.Optimizer):
    def __init__(
        ...
        **optimizer_kwargs,
        ...
        Args:
            ...
            optimizer_class (mindtorch.optim.Optimizer): the Optimizer to use
                locally, i.e. mindtorch.optim.SGD, mindtorch.optim.Adagrad, etc.
    ...
    def zero_grad(self, set_to_none: bool = True):  # type: ignore[override]
        r"""Resets the gradients of all optimized :class:`mindtorch.Tensor` s.
    ...
    def state_dict(self) -> Dict[str, Any]:
        ...
        instead of parameter indices like mindtorch.optim.Optimizer.
