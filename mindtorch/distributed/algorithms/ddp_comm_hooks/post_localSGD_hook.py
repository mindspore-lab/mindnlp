...
def post_localSGD_hook(
    ...
    :class:`~mindtorch.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`)
    ...
    Example::
        ...
        >>> # Please refer to the examples in ``mindtorch.distributed.algorithms.model_averaging.averagers`` module.
    """
    global_group_to_use = (
