...
class DDPCommHookType(Enum):
    ...
    DDPCommHookType enumerates the hooks of ``mindtorch.distributed.algorithms.ddp_comm_hooks``
...
def register_ddp_comm_hook(comm_hook_type: DDPCommHookType, model, state=None):
    ...
    Registers the hooks of ``mindtorch.distributed.algorithms.ddp_comm_hooks``
