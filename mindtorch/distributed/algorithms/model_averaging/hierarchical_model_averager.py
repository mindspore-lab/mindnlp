...
import mindtorch.distributed.algorithms.model_averaging.averagers as averagers
import mindtorch.distributed.algorithms.model_averaging.utils as utils
...
class HierarchicalModelAverager(averagers.ModelAverager):
    ...
    This is an extension of :class:`~mindtorch.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`
    ...
    level is usually embedded in :meth:`~mindtorch.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook`.
    ...
    Args:
        ...
        process_group (ProcessGroup, optional): The overall process group containing all the processes that runs model averaging.
                                                ...
                                                by :func:`mindtorch.distributed.init_process_group`, will be used.
                                                (default: ``None``)
    ...
    Example::
        ...
        >>> import mindtorch
        >>> import mindtorch.distributed as dist
        >>> from mindtorch.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook import (
        >>>     PostLocalSGDState,
        >>>     post_localSGD_hook,
        >>> )
        >>> import mindtorch.distributed.algorithms.model_averaging.hierarchical_model_averager as hierarchicalSGD
    ...
    def average_parameters(
        self,
        params: Union[
            Iterable[mindtorch.nn.Parameter], Iterable[Dict[str, mindtorch.nn.Parameter]]
        ],
    ):
        """
