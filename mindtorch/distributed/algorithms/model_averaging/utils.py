...
from mindtorch.distributed import group, ProcessGroup
...
def average_parameters(
    params: Iterator[mindtorch.nn.Parameter], process_group: ProcessGroup
):
    """
    ...
    flat_params = mindtorch.cat([p.data.reshape(-1) for p in params_it1])
...
def get_params_to_average(
    params: Union[Iterable[mindtorch.nn.Parameter], Iterable[Dict[str, mindtorch.nn.Parameter]]]
):
    """
