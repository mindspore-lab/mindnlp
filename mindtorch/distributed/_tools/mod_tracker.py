...
class ModTracker:
    ...
    .. code-block:: python
        ...
        mod = mindtorch.nn.Linear(2, 2)

        with ModTracker() as tracker:
            # Access anything during the forward pass
            def my_linear(m1, m2, bias):
                print(f"Current modules: {tracker.parents}")
                return mindtorch.mm(m1, m2.t()) + bias
            mindtorch.nn.functional.linear = my_linear

            mod(mindtorch.rand(2, 2))
    ...
    def _maybe_set_engine_callback(self):
        ...
        mindtorch.autograd.Variable._execution_engine.queue_callback(callback)
    ...
    def is_bw(self):
        ...
        """
        return mindtorch._C._current_graph_task_id() != -1
