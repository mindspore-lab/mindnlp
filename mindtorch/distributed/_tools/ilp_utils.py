...
import mindtorch
from mindtorch.distributed._tools.mem_tracker import (
    _MemRefType,
    _ModMemStats,
    _ModState,
    MemTracker,
...
from mindtorch.distributed._tools.sac_estimator import SACEstimator, SACTradeOffStats
...
def aggregate_stats(
    ...
    # Memory stats
    mod_mem_stats: Dict[mindtorch.nn.Module, _ModMemStats] = dict(
