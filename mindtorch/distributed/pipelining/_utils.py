...
def validate_tensors_metadata(
    desc,
    expected_tensors: Union[List[mindtorch.Tensor], Tuple[mindtorch.Tensor, ...]],
    actual_tensors: Union[List[mindtorch.Tensor], Tuple[mindtorch.Tensor, ...]],
):
