...
def get_rendezvous_handler(params: RendezvousParameters) -> RendezvousHandler:
    ...
    ::
      ...
      from mindtorch.distributed.elastic.rendezvous import rendezvous_handler_registry
      from mindtorch.distributed.elastic.rendezvous.registry import get_rendezvous_handler
