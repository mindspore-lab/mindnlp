...
from mindtorch.distributed.elastic.rendezvous import (
...
class EtcdRendezvousHandler(RendezvousHandler):
    """
    Implements a
    :py:class:`mindtorch.distributed.elastic.rendezvous.RendezvousHandler` interface
    backed by
    :py:class:`mindtorch.distributed.elastic.rendezvous.etcd_rendezvous.EtcdRendezvous`.
...
# Handler for mindtorch.distributed "static" registration
