...
from mindtorch.distributed import FileStore, Store, TCPStore
from mindtorch.distributed.elastic.events import construct_and_record_rdzv_event, NodeState
...
class C10dRendezvousBackend(RendezvousBackend):
    ...
    Args:
        store:
            The :py:class:`mindtorch.distributed.Store` instance to use to
    ...
    def __init__(self, store: Store, run_id: str) -> None:
        ...
        self._key = "mindtorch.rendezvous." + run_id
...
def create_backend(params: RendezvousParameters) -> Tuple[C10dRendezvousBackend, Store]:
    ...
    |              | :py:class:`mindtorch.distributed.TCPStore` and                |
    |              | :py:class:`mindtorch.distributed.FileStore`, respectively.    |
    |              | Defaults to "tcp".                                        |
    +--------------+-----------------------------------------------------------+
    ...
    |              | :py:class:`mindtorch.distributed.TCPStore`. It is not relevant|
    |              | to :py:class:`mindtorch.distributed.FileStore` which does not |
    ...
    |              | :py:class:`mindtorch.distributed.TCPStore`. In normal         |
