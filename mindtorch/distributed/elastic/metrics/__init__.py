...
::
  ...
  import time
  import mindtorch.distributed.elastic.metrics as metrics
...
You may also use the mindtorch.distributed.elastic.metrics.prof` decorator
...
`mindtorch.distributed.elastic.metrics.MetricHandler` is responsible for emitting
...
the `mindtorch.distributed.elastic.metrics.MetricHandler` interface
...
try:
    from mindtorch.distributed.elastic.metrics.static_init import *  # type: ignore[import] # noqa: F401 F403
