...
TorchElastic agents use :func:`mindtorch.distributed.elastic.multiprocessing.start_processes`
...
class ProcessFailure:
    ...
    .. note:: It is assumed that the ``error_file`` is written by
              ``mindtorch.distributed.elastic.multiprocessing.errors.error_handler.ErrorHandler``.
    ...
    def __post_init__(self):
        ...
        if not self.message:
            ...
            if self.exitcode < 0:
                ...
                self.message = "To enable traceback see: https://pymindtorch.org/docs/stable/elastic/errors.html"
                ...
                if failure.error_file != _NOT_AVAILABLE:
                    ...
                    logger.info(
                        (
                            ...
                            " See: https://pymindtorch.org/docs/stable/elastic/errors.html",
                            rank,
                        )
                    )
                raise
