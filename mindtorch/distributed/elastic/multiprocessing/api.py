...
from mindtorch.distributed.elastic.multiprocessing.errors import ProcessFailure, record
from mindtorch.distributed.elastic.multiprocessing.redirects import (
    redirect_stderr,
    redirect_stdout,
)
from mindtorch.distributed.elastic.multiprocessing.subprocess_handler import (
    get_subprocess_handler,
    SubprocessHandler,
)
from mindtorch.distributed.elastic.multiprocessing.tail_log import TailLog
...
class PContext(abc.ABC):
    ...
    The name ``PContext`` is intentional to disambiguate with ``mindtorch.multiprocessing.ProcessContext``.
...
class MultiprocessContext(PContext):
    ...
    def _poll(self) -> Optional[RunProcsResult]:
        ...
        try:
            # mindtorch.mp.ProcessContext Throws an Exception if some/all of
