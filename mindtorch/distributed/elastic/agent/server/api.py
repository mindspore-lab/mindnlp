...
import mindtorch.distributed.elastic.rendezvous as rdzv
import mindtorch.distributed.elastic.utils.store as store_util
from mindtorch.distributed.elastic.events import Event, EventSource, record
from mindtorch.distributed.elastic.metrics import prof, put_metric
from mindtorch.distributed.elastic.multiprocessing import ProcessFailure, SignalException
from mindtorch.distributed.elastic.rendezvous import RendezvousGracefulExitError
...
class SimpleElasticAgent(ElasticAgent):
    ...
    #  `mindtorch.distributed.elastic.metrics.prof`.
    @prof
