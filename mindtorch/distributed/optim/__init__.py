"""
:mod:`mindtorch.distributed.optim` exposes DistributedOptimizer, which takes a list
of remote parameters (:class:`~mindtorch.distributed.rpc.RRef`) and runs the
...
# DistributedOptimizer imports mindtorch.distributed.rpc names, so gate availability
# based on RPC being available.
if hasattr(mindtorch._C, "_rpc_init"):
