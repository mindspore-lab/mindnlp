...
class DistributedOptimizer:
    ...
    This class uses :meth:`~mindtorch.distributed.autograd.get_gradients` in order
    to retrieve the gradients for specific parameters.

    Concurrent calls to
    :meth:`~mindtorch.distributed.optim.DistributedOptimizer.step`,
    ...
    def __init__(self, optimizer_class, params_rref, *args, **kwargs):
        mindtorch._C._log_api_usage_once("mindtorch.distributed.optim.DistributedOptimizer")
    ...
    def step(self, context_id):
        ...
        This will call :meth:`mindtorch.optim.Optimizer.step` on each worker
        ...
        corresponding :class:`~mindtorch.distributed.autograd.context` that
