...
def _keep_visiting_tensors(value: STATE_DICT_ITEM) -> bool:
    return isinstance(value, mindtorch.Tensor)
...
def traverse_state_dict_v_2_3(
    ...
    By default, all collections with at least one ``mindtorch.Tensor`` element are traversed.
...
def _print_nested(
    ...
    #         print_fun=print_fun,
    #     )
    elif isinstance(value, mindtorch.Tensor):
