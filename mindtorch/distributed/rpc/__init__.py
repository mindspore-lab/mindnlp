...
# if is_available() and not mindtorch._C._rpc_init():
#     raise RuntimeError("Failed to initialize mindtorch.distributed.rpc")
...
if is_available():
    ...
    from mindtorch._C._distributed_rpc import (  # noqa: F401
    ...
    def init_rpc(
        ...
        Args:
            ...
            rpc_backend_options (RpcBackendOptions, optional): The options
                ...
                subclass of :class:`~mindtorch.distributed.rpc.RpcBackendOptions`
                ...
                are available.
        """
        mindtorch._C._log_api_usage_once("mindtorch.distributed.init_rpc")
        ...
        # mindtorch.distributed.autograd.backward() would run into errors since
