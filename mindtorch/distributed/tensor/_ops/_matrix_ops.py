...
def scaled_dot_product_cudnn_attention_strategy(op_schema: OpSchema) -> OpStrategy:
    ...
    all_replicate: PlacementList = [
        ...
        None,  # philox_seed
        None,  # philox_offset
        # NOTE: debug_attn_mask is not supproted by pymindtorch and is always an empty tensor
        # https://github.com/pymindtorch/pymindtorch/blob/60205b0eb2602317856312a66d955c88334ade0b/aten/src/ATen/native/transformers/cuda/attention.cu#L839-L840
