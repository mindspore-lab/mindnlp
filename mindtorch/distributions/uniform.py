...
import mindtorch
from mindtorch import nan, Tensor
...
class Uniform(Distribution):
    ...
    def __init__(self, low, high, validate_args=None):
        ...
        if self._validate_args and not mindtorch.lt(self.low, self.high).all():
    ...
    def rsample(self, sample_shape: _size = mindtorch.Size()) -> Tensor:
        ...
        rand = mindtorch.rand(shape, dtype=self.low.dtype, device=self.low.device)
    ...
    def log_prob(self, value):
        ...
        return mindtorch.log(lb.mul(ub)) - mindtorch.log(self.high - self.low)
    ...
    def entropy(self):
        return mindtorch.log(self.high - self.low)