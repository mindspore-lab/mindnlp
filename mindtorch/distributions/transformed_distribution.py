...
class TransformedDistribution(Distribution):
    ...
    :class:`~mindtorch.distributions.gumbel.Gumbel`,
    :class:`~mindtorch.distributions.half_cauchy.HalfCauchy`,
    :class:`~mindtorch.distributions.half_normal.HalfNormal`,
    :class:`~mindtorch.distributions.log_normal.LogNormal`,
    :class:`~mindtorch.distributions.pareto.Pareto`,
    :class:`~mindtorch.distributions.weibull.Weibull`,
    :class:`~mindtorch.distributions.relaxed_bernoulli.RelaxedBernoulli` and
    :class:`~mindtorch.distributions.relaxed_categorical.RelaxedOneHotCategorical`
    """
