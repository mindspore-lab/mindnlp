...
any_op = Any().set_device('Ascend')

any_ext_op = AnyExt().set_device('Ascend')
...
cross_entropy_loss_op = CrossEntropyLoss().set_device('Ascend')

cross_entropy_loss_grad_op = CrossEntropyLossGrad().set_device('Ascend')
...
dequant_swiglu_quant_op = DequantSwigluQuant().set_device('Ascend')
...
dist_comm_all_gather_into_tensor_uneven_op = DistCommAllGatherIntoTensorUneven().set_device('Ascend')

dist_comm_all_reduce_op = DistCommAllReduce().set_device('Ascend')

dist_comm_all_to_all_v_op = DistCommAllToAllV().set_device('Ascend')

dist_comm_all_to_all_v_c_op = DistCommAllToAllVC().set_device('Ascend')
...
dist_comm_reduce_scatter_tensor_uneven_op = DistCommReduceScatterTensorUneven().set_device('Ascend')
...
dropout2d_ext_op = Dropout2dExt().set_device('Ascend')
...
einsum_ext_op = EinsumExt().set_device('Ascend')
...
empty_op = Empty().set_device('Ascend')

empty_like_op = EmptyLike().set_device('Ascend')
...
func_dropout_ext_op = FuncDropoutExt().set_device('Ascend')

func_max_pool2d_op = FuncMaxPool2D().set_device('Ascend')
...
imag_view_op = ImagView().set_device('Ascend')
...
inner_moe_token_unpermute_op = InnerMoeTokenUnpermute().set_device('Ascend')

inner_non_zero_op = InnerNonZero().set_device('Ascend')

inner_unique_op = InnerUnique().set_device('Ascend')
...
inplace_bernoulli_scalar_op = InplaceBernoulliScalar().set_device('Ascend')

inplace_bernoulli_tensor_op = InplaceBernoulliTensor().set_device('Ascend')
...
inplace_index_copy_op = InplaceIndexCopy().set_device('Ascend')

inplace_index_fill_scalar_op = InplaceIndexFillScalar().set_device('Ascend')

inplace_index_fill_tensor_op = InplaceIndexFillTensor().set_device('Ascend')
...
inplace_matmul_add_op = InplaceMatmulAdd().set_device('Ascend')
...
inplace_remainder_tensor_scalar_op = InplaceRemainderTensorScalar().set_device('Ascend')

inplace_remainder_tensor_tensor_op = InplaceRemainderTensorTensor().set_device('Ascend')
...
inplace_sigmoid_op = InplaceSigmoid().set_device('Ascend')

inplace_sign_op = InplaceSign().set_device('Ascend')

inplace_silu_op = InplaceSiLU().set_device('Ascend')
...
masked_fill_scalar_op = MaskedFillScalar().set_device('Ascend')
...
mla_op = Mla().set_device('Ascend')

mm_ext_op = Mm().set_device('Ascend')

moe_compute_expert_tokens_op = MoeComputeExpertTokens().set_device('Ascend')

moe_distribute_combine_op = MoeDistributeCombine().set_device('Ascend')

moe_distribute_dispatch_op = MoeDistributeDispatch().set_device('Ascend')
...
new_empty_op = NewEmpty().set_device('Ascend')

new_full_op = NewFull().set_device('Ascend')
...
quant_matmul_op = QuantMatmul().set_device('Ascend')
...
real_view_op = RealView().set_device('Ascend')
...
ring_attention_update_op = RingAttentionUpdate().set_device('Ascend')
...
to_device_op = ToDevice().set_device('Ascend')

to_dtype_op = ToDtype().set_device('Ascend')

to_other_op = ToOther().set_device('Ascend')
