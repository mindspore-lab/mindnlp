...
class Module:
    ...
    def add_module(self, name: str, module: Optional["Module"]) -> None:
        ...
        if not isinstance(module, Module) and module is not None:
            raise TypeError(f"{mindtorch.typename(module)} is not a Module subclass")
        elif not isinstance(name, str):
            raise TypeError(
                f"module name should be a string. Got {mindtorch.typename(name)}"
            )
    ...
    def get_parameter(self, target: str) -> "Parameter":
        ...
        Returns:
            mindtorch.nn.Parameter: The Parameter referenced by ``target``
    ...
    def get_buffer(self, target: str) -> "Tensor":
        ...
        Returns:
            mindtorch.Tensor: The buffer referenced by ``target``
    ...
    def _apply(self, fn, recurse=True):
        ...
        def compute_should_use_set_data(tensor, tensor_applied):
            if mindtorch._has_compatible_shallow_copy_type(tensor, tensor_applied):
                ...
                return not mindtorch.__future__.get_overwrite_module_params_on_conversion()
            else:
                return False

        should_use_swap_tensors = (
            mindtorch.__future__.get_swap_module_params_on_conversion()
        )
    ...
    def __setattr__(self, name: str, value: Union[Tensor, "Module"]) -> None:
        ...
        if isinstance(value, Parameter):
            ...
            if value is not None:
                raise TypeError(
                    f"cannot assign '{mindtorch.typename(value)}' as parameter '{name}' "
            ...
            if isinstance(value, Module):
                ...
                if value is not None:
                    raise TypeError(
                        f"cannot assign '{mindtorch.typename(value)}' as child module '{name}' "
                        "(mindtorch.nn.Module or None expected)"
                    )
                for hook in _global_module_registration_hooks.values():
                    output = hook(self, name, value)
                    if output is not None:
                ...
                if isinstance(value, Buffer) or buffers is not None and name in buffers:
                    if value is not None and not isinstance(value, mindtorch.Tensor):
                        raise TypeError(
                            f"cannot assign '{mindtorch.typename(value)}' as buffer '{name}' "
                            "(mindtorch.nn.Buffer, mindtorch.Tensor or None expected)"
                        )
    ...
    def _register_state_dict_hook(self, hook):
        r"""Register a post-hook for the :meth:`~mindtorch.nn.Module.state_dict` method.
    ...
    def _load_from_state_dict(
        ...
        in :meth:`~mindtorch.nn.Module.load_state_dict`. Metadata saved for this
        ...
        .. note::
            ...
            :attr:`state_dict` to :meth:`~mindtorch.nn.Module.load_state_dict`. So
            it can be modified.
        ...
        Args:
            ...
            error_msgs (list of str): error messages should be added to this
                ...
                :meth:`~mindtorch.nn.Module.load_state_dict`
        """
    ...
    def to_empty(
        ...
        """
        return self._apply(
            lambda t: mindtorch.empty_like(t, device=device), recurse=recurse
        )
