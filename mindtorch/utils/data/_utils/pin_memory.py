...
def _pin_memory_loop(in_queue, out_queue, device_id, done_event, device):
    ...
    mindtorch.multiprocessing._set_thread_name("pt_data_pin")

    if device == "cuda":
        mindtorch.cuda.set_device(device_id)
    elif device == "xpu":
        mindtorch.xpu.set_device(device_id)  # type: ignore[attr-defined]
    elif device == mindtorch._C._get_privateuse1_backend_name():
        custom_device_mod = getattr(torch, mindtorch._C._get_privateuse1_backend_name())
