    ...
    *,
    ...
    Args:
        ...
        to_dumpable_context: An optional keyword argument to custom specify how
            ...
            used in mindtorch.export right now.
        from_dumpable_context: An optional keyword argument to custom specify how
            ...
            which is being used in mindtorch.export right now.
...
@deprecated(
    "`mindtorch.utils._pytree._register_pytree_node` is deprecated. "
    "Please use `mindtorch.utils._pytree.register_pytree_node` instead.",
