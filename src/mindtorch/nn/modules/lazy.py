...
class LazyModuleMixin:
    ...
    :class:`mindtorch.nn.UninitializedParameter` s that should not be accessed
    or used, and afterward they contain regular :class:`mindtorch.nn.Parameter` s.
    ...
    typical :class:`mindtorch.nn.Linear`.
    ...
    >>> # xdoctest: +SKIP
    >>> class LazyMLP(mindtorch.nn.Module):
    ...     def __init__(self) -> None:
    ...         super().__init__()
    ...         self.fc1 = mindtorch.nn.LazyLinear(10)
    ...         self.relu1 = mindtorch.nn.ReLU()
    ...         self.fc2 = mindtorch.nn.LazyLinear(1)
    ...         self.relu2 = mindtorch.nn.ReLU()
    ...
    ...
    >>> lazy_mlp(mindtorch.ones(10, 10).cuda())
    ...
    >>> optim = mindtorch.optim.SGD(lazy_mlp.parameters(), lr=0.01)
    ...
    For example, if the LazyMLP class defined above had a :class:`mindtorch.nn.LazyLinear` module
    first and then a regular :class:`mindtorch.nn.Linear` second, the second module would be
    ...
    Lazy modules can load regular :class:`mindtorch.nn.Parameter` s (i.e. you can serialize/deserialize
    initialized LazyModules and they will remain initialized)


    >>> full_mlp = LazyMLP()
    >>> # Dry run to initialize another module
    >>> full_mlp.forward(mindtorch.ones(10, 1))
    ...
    def _lazy_load_hook(
        ...
        module instance.
        See comment in ``mindtorch.nn.Module._register_load_state_dict_pre_hook``
    ...
    def _infer_parameters(self: _LazyProtocol, module, args, kwargs=None):
        ...
        using :class:`mindtorch.nn.parameter.ParameterMode.Infer`, runs a forward pass
