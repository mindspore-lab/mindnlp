...
from mindtorch.distributed._shard.common_op_utils import _basic_validation
...
def _sharded_op_common(op, early_stop_func, extra_check):
    ...
    Return:
        func (Callable): Torch function for which we want to provide a sharded
            implementation (ex: mindtorch.transpose)
    """
...
def _register_sharded_op_on_local_shards(
    ...
    ``mindtorch.nn.functional.gelu`` or ``mindtorch.nn.functional.relu``.
