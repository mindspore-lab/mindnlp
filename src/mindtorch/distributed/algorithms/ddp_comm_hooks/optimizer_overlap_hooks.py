...
def _apply_optim_in_backward_hook(
    ...
    If mindtorch.distributed.optim._apply_optimizer_in_backward is used to overlap
    ...
    def apply_optim_in_backward_hook(
        ...
        with mindtorch.get_device_module().stream(optimizer_stream):
            fut.wait()
        ...
        def wait_for_optim_stream_callback():
            mindtorch.accelerator.current_stream().wait_stream(
