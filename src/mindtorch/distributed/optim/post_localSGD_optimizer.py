...
class PostLocalSGDOptimizer(mindtorch.optim.Optimizer):
    r"""
    Wraps an arbitrary :class:`mindtorch.optim.Optimizer` and runs `post-local SGD <https://arxiv.org/abs/1808.07217>`_,
    ...
    Example::
        ...
        >>> from mindtorch.distributed.optim import PostLocalSGDOptimizer
        ...
        >>> local_optim = mindtorch.optim.SGD(params=model.parameters(), lr=0.01)
    ...
    def __init__(self, optim: mindtorch.optim.Optimizer, averager: averagers.ModelAverager):
        self.optim = optim
    ...
    def state_dict(self):
        r"""
        This is the same as :class:`mindtorch.optim.Optimizer` :meth:`state_dict`,
    ...
    def load_state_dict(self, state_dict):
        r"""
        This is the same as :class:`mindtorch.optim.Optimizer` :meth:`load_state_dict`,
