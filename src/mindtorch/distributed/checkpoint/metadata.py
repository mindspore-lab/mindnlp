...
import mindtorch
from mindtorch.distributed.checkpoint.stateful import StatefulT
...
class TensorProperties:
    ...
    dtype: mindtorch.dtype = field(default_factory=mindtorch.get_default_dtype)
...
class MetadataIndex:
    ...
    offset: Optional[mindtorch.Size] = None
    ...
    def __init__(
        ...
        if offset is not None:
            object.__setattr__(self, "offset", mindtorch.Size(offset))
