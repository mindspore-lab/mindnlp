...
from mindtorch.distributed._shard.sharded_tensor import Shard, ShardedTensor, ShardMetadata
from mindtorch.distributed.checkpoint.metadata import STATE_DICT_TYPE
...
if TYPE_CHECKING:
    from mindtorch.distributed._shard.sharded_tensor.metadata import ShardedTensorMetadata
