...
from mindtorch.distributed._composable import contract
from mindtorch.distributed.tensor import DeviceMesh, Shard
from mindtorch.distributed.utils import _get_root_modules
    ...
    *,
    ...
    Args:
        ...
        reshard_after_forward (Union[bool, int]): This controls the parameter
            ...
            may be the intra-node size (e.g. ``mindtorch.cuda.device_count()``).
...
class FSDPModule:
    ...
    def set_post_optim_event(self, event: mindtorch.Event) -> None:
        """
        ...
        Args:
            event (mindtorch.Event): Event recorded after the optimizer step
    ...
    def set_reduce_scatter_divide_factor(self, factor: float) -> None:
        ...
        if (fsdp_param_group := state._fsdp_param_group) is not None:
            ...
            reduce_op = mindtorch.distributed._make_nccl_premul_sum(mul_factor)
