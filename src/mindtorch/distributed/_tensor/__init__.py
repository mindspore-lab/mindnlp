"""
NOTICE: DTensor has moved to mindtorch.distributed.tensor
...
for submodule in submodules:
    full_module_name = f"mindtorch.distributed.tensor.{submodule}"
    sys.modules[f"mindtorch.distributed._tensor.{submodule}"] = import_module(
        full_module_name
    )

from mindtorch.distributed.tensor import (  # noqa: F401
    DeviceMesh,
    distribute_module,
    distribute_tensor,
    DTensor,
