...
def max_clock_rate():
    ...
    if not mindtorch.version.hip:
        ...
        gcn_arch = str(mindtorch.cuda.get_device_properties(0).gcnArchName.split(":", 1)[0])
...
# mindtorch.library.register_fake, returns if we require that there be a
...
def deprecated():
    ...
    by adding a leading undersmindtorch. This decorator is used with a private function,
