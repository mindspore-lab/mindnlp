...
class Independent(Distribution):
    ...
    interchangeable), you can::
        ...
        >>> from mindtorch.distributions.multivariate_normal import MultivariateNormal
        >>> from mindtorch.distributions.normal import Normal
        >>> loc = mindtorch.zeros(3)
        >>> scale = mindtorch.ones(3)
        >>> mvn = MultivariateNormal(loc, scale_tril=mindtorch.diag(scale))
        >>> [mvn.batch_shape, mvn.event_shape]
        [mindtorch.Size([]), mindtorch.Size([3])]
        >>> normal = Normal(loc, scale)
        >>> [normal.batch_shape, normal.event_shape]
        [mindtorch.Size([3]), mindtorch.Size([])]
        >>> diagn = Independent(normal, 1)
        >>> [diagn.batch_shape, diagn.event_shape]
        [mindtorch.Size([]), mindtorch.Size([3])]

    Args:
        base_distribution (mindtorch.distributions.distribution.Distribution): a
            base distribution
