...
class Transform:
    ...
    :class:`mindtorch.distributions.TransformedDistribution`.
    ...
    Attributes:
        domain (:class:`~mindtorch.distributions.constraints.Constraint`):
            The constraint representing valid inputs to this transform.
        codomain (:class:`~mindtorch.distributions.constraints.Constraint`):
