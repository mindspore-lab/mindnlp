...
"""
Model card generation for merged models.
...
from .config import MergeConfiguration, ModelReference
...
This is a merge of pre-trained language models created using [Wizard](https://github.com/mindspore-lab/mindnlp).
...
This is a LoRA extracted from a language model. It was extracted using [Wizard](https://github.com/mindspore-lab/mindnlp).
...
def generate_card_lora(  # pylint: disable=too-many-positional-arguments
