...
try:
    from mindnlp.transformers import PretrainedConfig, MistralConfig, MixtralConfig
except ImportError:
    from transformers import PretrainedConfig, MistralConfig, MixtralConfig
...
class MixtralMoE(MoEOutputArchitecture):
    ...
    def _generate_config(
        ...
        if not isinstance(base_config, MistralConfig):
            base_cfg_mistral = MistralConfig(**base_config.to_dict())
        ...
        out_cfg = MixtralConfig(**base_config.to_dict())
