...
from ..common import get_accelerator_count
from .actors import InMemoryMergeEvaluator, OnDiskMergeEvaluator
from .config import EvolMergeConfiguration
from .genome import ModelGenome
from .helpers import evaluate_model_ray, merge_model_ray
...
class EvaluationStrategyBase(ABC):
    def __init__(  # pylint: disable=too-many-positional-arguments
        ...
        self.num_gpus = num_gpus or get_accelerator_count(
...
@ray.remote
def evaluate_genotype_serial(  # pylint: disable=too-many-positional-arguments
    genotype: np.ndarray,
    config: EvolMergeConfiguration,
    genome: ModelGenome,
    merge_options: MergeOptions,
