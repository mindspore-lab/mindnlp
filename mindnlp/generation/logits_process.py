...
class TopPLogitsWarper(LogitsWarper):
    ...
    def __call__(self, input_ids: Tensor.LongTensor, scores: Tensor.FloatTensor) -> Tensor.FloatTensor:
        sorted_logits, sorted_indices = Tensor.sort(scores, descending=False)
