...
from ..dataset.transforms import JiebaTokenizer
from ..configs import MINDNLP_CACHE
from ..utils import logging, http_get

logger = logging.get_logger(__name__)

pwd_path = os.path.abspath(os.path.dirname(__file__))
default_stopwords_file = os.path.join(pwd_path, 'stopwords.txt')
USER_DATA_DIR = os.path.join(MINDNLP_CACHE, 'word2vec')
