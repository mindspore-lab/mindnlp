...
class ImageClassificationPipeline(Pipeline):
    ...
    def preprocess(self, image, timeout=None):
        ...
        model_inputs = self.image_processor(images=image, return_tensors="ms")
    ...
    def postprocess(self, model_outputs, function_to_apply=None, top_k=5):
        ...
        if outputs.dtype in (mindspore.bfloat16, mindspore.float16):
            outputs = outputs.to(mindspore.float32).numpy()
        else:
