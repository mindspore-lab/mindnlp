...
class MSErnieSelfOutput(nn.Cell):
    ...
    Methods:
        ...
        construct: Constructs the self-output layer by performing dense, dropout, and LayerNorm operations on the hidden states.
    ...
    def construct(self, hidden_states: mindspore.Tensor) -> mindspore.Tensor:
        ...
        Args:
            ...
            hidden_states (mindspore.Tensor): A tensor containing the hidden states. It is expected to be of shape (batch_size, sequence_length, hidden_size) where batch_size represents the number of input
                sequences in the batch, sequence_length represents the length of the sequences, and hidden_size represents the size of the hidden states.
...
class MSErnieForNextSentencePrediction(MSErniePreTrainedModel):
    ...
    Note:
        The 'next_sentence_label' argument in the construct method is deprecated and will be removed in a future version. Use the 'labels' argument instead.
    """
