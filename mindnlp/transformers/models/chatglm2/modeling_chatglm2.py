...
class CoreAttention(nn.Cell):
    ...
    Methods:
        ...
        construct: Constructs the attention mechanism by performing attention operations on the input query, key, and value layers with the optional attention mask.
