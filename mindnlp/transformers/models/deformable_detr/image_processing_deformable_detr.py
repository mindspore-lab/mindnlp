...
def convert_segmentation_to_rle(segmentation):
    ...
    """
    segment_ids = mindspore.ops.unique(segmentation)

    run_length_encodings = []
    for idx in segment_ids:
        mask = mindspore.ops.where(segmentation == idx, 1, 0)
...
def compute_segments(
    ...
    segmentation = mindspore.ops.zeros((height, width), dtype=mindspore.int32)
    segments: List[Dict] = []
...
class DeformableDetrImageProcessor(BaseImageProcessor):
    ...
    def post_process(self, outputs, target_sizes):
        ...
        scale_fct = mindspore.ops.stack([img_w, img_h, img_w, img_h], axis=1)
