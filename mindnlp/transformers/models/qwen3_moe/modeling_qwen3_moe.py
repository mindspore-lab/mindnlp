...
from ....utils import LossKwargs, can_return_tuple, logging
...
class Qwen3MoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        """
        Args:
            hidden_states (`mindspore.float32`): input to the layer of shape `(batch, seq_len, embed_dim)`
            attention_mask (`mindspore.float32`, *optional*): attention mask of size
            ...
            use_cache (`bool`, *optional*):
                ...
                (see `past_key_values`).
            past_key_value (`Tuple(mindspore.float32)`, *optional*): cached past key and value projection states
            cache_position (`mindspore.int64` of shape `(sequence_length)`, *optional*):
                Indices depicting the position of the input sequence tokens in the sequence.
            position_embeddings (`Tuple[mindspore.float32, mindspore.float32]`, *optional*):
...
class Qwen3MoeRotaryEmbedding(nn.Module):
    ...
    @no_grad() # power user: used with advanced RoPE types (e.g. dynamic rope)
...
class Qwen3MoeModel(Qwen3MoePreTrainedModel):
    ...
    def _prepare_4d_causal_attention_mask_with_cache_position(
        ...
        if attention_mask is not None and attention_mask.dim() == 4:
            ...
            diagonal_attend_mask = ops.arange(target_length) > cache_position.reshape(
                -1, 1
            )
...
class Qwen3MoeForSequenceClassification(Qwen3MoePreTrainedModel):
    ...
    def forward(
        ...
        if self.config.pad_token_id is None:
            ...
            token_indices = ops.arange(input_ids.shape[-1], dtype=mindspore.int32)
        ...
        pooled_logits = logits[ops.arange(batch_size), last_non_pad_token]
