...
class MSAutoModelForImageClassification(_BaseAutoModelClass):
    ...
    Note:
        The 'MSAutoModelForImageClassification' class requires a valid Microsoft Azure cognitive services subscription and the necessary API keys for authentication and authorization.
