...
if TYPE_CHECKING:
    from mindnlp.transformers import MaskFormerForInstanceSegmentationOutput
...
class MaskFormerImageProcessor(BaseImageProcessor):
    ...
    def encode_inputs(
        ...
        if segmentation_maps is not None:
            ...
            for idx, segmentation_map in enumerate(segmentation_maps):
                ...
                mask_labels.append(ops.from_numpy(masks))
                class_labels.append(ops.from_numpy(classes))
    ...
    def post_process_instance_segmentation(
        ...
        for i in range(class_queries_logits.shape[0]):
            ...
            labels = ops.arange(num_classes).unsqueeze(0).repeat(num_queries, 1).flatten(0, 1)
            ...
            segmentation = ops.zeros(masks_queries_logits.shape[2:]) - 1
            if target_sizes is not None:
            ...
            if return_binary_maps and len(instance_maps) != 0:
                segmentation = ops.stack(instance_maps, dim=0)
