...
from .longt5_config import LongT5Config, LONGT5_SUPPORT_LIST
from ...modeling_utils import PreTrainedModel
from ...activations import ACT2FN


__all__ = ['LongT5Attention', 'LongT5DenseActDense', 'LongT5DenseGatedActDense', 'LongT5EncoderModel',
           'LongT5ForConditionalGeneration', 'LongT5LayerCrossAttention', 'LongT5Stack', 'LongT5LayerSelfAttention',
           'LongT5LayerNorm', 'LongT5Model', 'LongT5LayerFF', 'LongT5Block', 'LongT5PreTrainedModel']

PRETRAINED_MODEL_ARCHIVE_MAP = {
    model: MS_MODEL_URL_BASE.format(model) for model in LONGT5_SUPPORT_LIST
}
...
def _make_3block_relative_position_ids(block_len: int) -> mindspore.Tensor:
    ...
    position_ids = mindspore.arange(3 * block_len, dtype=mindspore.int32)
...
class LongT5LocalAttention(nn.Cell):
    ...
    def compute_bias(self, block_length: int):
        ...
        memory_position = arange(3 * block_length, dtype=mindspore.int64)
