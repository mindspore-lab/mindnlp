...
LONGT5_SUPPORT_LIST = ["google/long-t5-local-base", "google/long-t5-local-large",
    "google/long-t5-tglobal-base", "google/long-t5-tglobal-large"]

CONFIG_ARCHIVE_MAP = {
    model: MS_CONFIG_URL_BASE.format(model) for model in LONGT5_SUPPORT_LIST
}

class LongT5Config(PretrainedConfig):
    """
    Configuration for LongT5
    """
