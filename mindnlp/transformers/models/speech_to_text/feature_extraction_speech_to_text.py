...
import numpy as np
from mindnlp.utils import PaddingStrategy, TensorType, is_speech_available, logging
...
class Speech2TextFeatureExtractor(SequenceFeatureExtractor):
    ...
    def _extract_fbank_features(
        ...
        if is_speech_available():
            waveform = ops.from_numpy(waveform).unsqueeze(0)
