...
class WhisperAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = nn.Linear(embed_dim, embed_dim, has_bias=False)
...
class WhisperForConditionalGeneration(WhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.proj_out = nn.Linear(config.d_model, config.vocab_size, has_bias=False)
...
class WhisperForCausalLM(WhisperPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.proj_out = nn.Linear(config.hidden_size, config.vocab_size, has_bias=False)
