...
class SiglipTextConfig(PretrainedConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        """
        Creates a SiglipTextConfig instance from a pretrained model.
        ...
        Returns:
            PretrainedConfig: A SiglipTextConfig instance initialized with the configuration specified by the pretrained model.
...
class SiglipVisionConfig(PretrainedConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        Note: If the loaded configuration belongs to the 'siglip' model type, the 'config_dict' will be updated to use the
        ...
        Example:
            ```python
            >>> config = SiglipVisionConfig.from_pretrained("siglip_model")
            ...
            ```
            In the above example, the 'from_pretrained' method is called on the 'SiglipVisionConfig' class to load the pretrained
            configuration of the 'siglip_model'. The resulting configuration is stored in the 'config' variable.
        """
        config_dict, kwargs = cls.get_config_dict(pretrained_model_name_or_path, **kwargs)
