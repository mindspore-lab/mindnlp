...
class Pix2StructVisionConfig(PretrainedConfig):
    ...
    Args:
        ...
        dense_act_fn (`str` or `function`, *optional*, defaults to `"gelu_new"`):
            The non-linear activation function (function or string) in the encoder and pooler. If strung, `"gelu"`,
...
class Pix2StructConfig(PretrainedConfig):
    ...
    def from_text_vision_configs(
        ...
        r"""
        Instantiate a [`Pix2StructConfig`] (or a derived class) from instruct text model configuration and instruct
