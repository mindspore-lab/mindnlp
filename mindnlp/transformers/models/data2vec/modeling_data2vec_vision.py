...
class Data2VecVisionRelativePositionBias(nn.Cell):
    ...
    def construct(self, interpolate_pos_encoding: bool = False, dim_size: Optional[int] = None) -> mindspore.Tensor:
...
# Copied from transformers.models.beit.modeling_beit.Data2VecVisionEncoder with Beit->Data2VecVision
...
class Data2VecVisionForSemanticSegmentation(Data2VecVisionPreTrainedModel):
    def __init__(self, config: Data2VecVisionConfig) -> None:
        ...
        self.fpn1 = nn.SequentialCell(
            nn.Conv2dTranspose(config.hidden_size, config.hidden_size, kernel_size=2, stride=2),
