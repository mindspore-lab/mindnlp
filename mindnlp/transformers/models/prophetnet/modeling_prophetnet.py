...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        # print('//self.word_embeddings.get_parameters',self.word_embeddings.get_parameters)
        # print('//self.word_embeddings.weight',self.word_embeddings.weight)
        # np.set_printoptions(threshold=np.inf)
        # for n,p in self.word_embeddings.parameters_and_names():
        #     print(f"{n}:{p.shape}\n{p.asnumpy()}\n")
        ...
        # print('//inputs_embeds(after:inputs_embeds = self.word_embeddings(input_ids))\n',inputs_embeds)
