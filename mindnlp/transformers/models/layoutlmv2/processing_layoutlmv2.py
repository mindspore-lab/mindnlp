...
class LayoutLMv2Processor(ProcessorMixin):
    ...
    def __init__(self, image_processor=None, tokenizer=None, **kwargs):
        ...
        Args:
            ...
            image_processor (object): An object representing the image processor. It can be an instance of a specific image processing class or None. If None, it will default to the value of 'feature_extractor'.
