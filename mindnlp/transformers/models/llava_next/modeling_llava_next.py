...
class LlavaNextForConditionalGeneration(LlavaNextPreTrainedModel):
    ...
    def _merge_input_ids_with_image_features(self, image_features, inputs_embeds, input_ids, attention_mask, labels):
        ...
        # batch_indices, non_image_indices = ops.where(input_ids != self.config.image_token_index)
        ...
        # batch_indices, pad_indices = ops.where(input_ids == self.pad_token_id)
    ...
    def construct(
        ...
        if inputs_embeds is None:
            ...
            inputs_embeds = self.get_input_embeddings()(input_ids.reshape((1, -1)))
                ...
                for image_idx, image_feature in enumerate(image_features):
                    if image_feature.shape[0] > 1:
                        ...
                        num_patch_height, num_patch_width = get_anyres_image_grid_shape(
                            image_sizes[image_idx].asnumpy().tolist(),
                        ...
                        image_feature = unpad_image(
                            image_feature, image_sizes[image_idx].asnumpy().tolist())
            ...
            # generation with cache
                ...
                # batch_index, non_attended_tokens = ops.where(first_layer_past_key_value.float().sum(-2) == 0)
                nonzero_result = ops.nonzero(
