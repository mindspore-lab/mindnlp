...
class JukeboxTokenizationTest(unittest.TestCase):
    ...
    def test_1b_lyrics_tokenizer(self):
        ...
        # fmt: on
        self.assertTrue(ops.allclose(tokens[0], EXPECTED_OUTPUT[0]))
        self.assertTrue(ops.allclose(tokens[1], EXPECTED_OUTPUT[1]))
        self.assertTrue(ops.allclose(tokens[2], EXPECTED_OUTPUT[2]))
