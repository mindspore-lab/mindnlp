...
from mindnlp.transformers.generation.stopping_criteria import StoppingCriteria
...
def process_anyres_image(image, processor, grid_pinpoints):
    ...
    return ms.ops.stack(image_patches, axis=0)
...
def process_images(images, image_processor, model_cfg):
    ...
    if image_aspect_ratio == 'pad':
        for image in images:
            ...
            image = image_processor.preprocess(image, return_tensors='ms')[
                'pixel_values'][0]
...
class KeywordsStoppingCriteria(StoppingCriteria):
    ...
    def call_for_batch(self, output_ids: ms.Tensor, scores: ms.Tensor, **kwargs) -> bool:
        ...
        for keyword_id in self.keyword_ids:
            ...
            if ms.ops.equal(truncated_output_ids, keyword_id):
                return True
