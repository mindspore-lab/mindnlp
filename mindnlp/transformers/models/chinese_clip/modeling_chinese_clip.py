...
def chinese_clip_loss(similarity: mindspore.Tensor) -> mindspore.Tensor:
...
class ChineseCLIPVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: mindspore.Tensor, interpolate_pos_encoding=False) -> mindspore.Tensor:
        ...
        if isinstance(module, ChineseCLIPVisionEmbeddings):
            ...
            for embedding in [module.word_embeddings, module.position_embeddings, module.token_type_embeddings]:
                if embedding.padding_idx is not None:
                    embedding.weight.data[embedding.padding_idx] = 0
