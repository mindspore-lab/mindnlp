...
def _find_cuda_home():
    ...
    This function searches for the CUDA home directory on the system. It first checks the environment variables 'CUDA_HOME' and 'CUDA_PATH' to see if either of them is set. If not, it tries to locate the 'nvcc' executable using the 'which' command and extracts the CUDA home directory path from it.
