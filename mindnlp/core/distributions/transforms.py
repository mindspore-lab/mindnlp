...
class Transform:
    ...
    :class:`core.distributions.TransformedDistribution`.
    ...
    Attributes:
        domain (:class:`~core.distributions.constraints.Constraint`):
            The constraint representing valid inputs to this transform.
        codomain (:class:`~core.distributions.constraints.Constraint`):
