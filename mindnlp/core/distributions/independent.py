...
class Independent(Distribution):
    ...
    interchangeable), you can::
        ...
        >>> from core.distributions.multivariate_normal import MultivariateNormal
        >>> from core.distributions.normal import Normal
        >>> loc = core.zeros(3)
        >>> scale = core.ones(3)
        >>> mvn = MultivariateNormal(loc, scale_tril=core.diag(scale))
        >>> [mvn.batch_shape, mvn.event_shape]
        [core.Size([]), core.Size([3])]
    ...
    Args:
        base_distribution (core.distributions.distribution.Distribution): a
            base distribution
