...
class TransformedDistribution(Distribution):
    ...
    :class:`~core.distributions.gumbel.Gumbel`,
    :class:`~core.distributions.half_cauchy.HalfCauchy`,
    :class:`~core.distributions.half_normal.HalfNormal`,
    :class:`~core.distributions.log_normal.LogNormal`,
    :class:`~core.distributions.pareto.Pareto`,
    :class:`~core.distributions.weibull.Weibull`,
    :class:`~core.distributions.relaxed_bernoulli.RelaxedBernoulli` and
    :class:`~core.distributions.relaxed_categorical.RelaxedOneHotCategorical`
    """
