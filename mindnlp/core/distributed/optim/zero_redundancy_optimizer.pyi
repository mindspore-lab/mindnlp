...
from core.distributed.algorithms.join import Joinable, JoinHook
...
class ZeroRedundancyOptimizer(Optimizer, Joinable):
    ...
    optim: Any = ...
    _device_to_device_index: dict[core.device, int] = ...
    _overlap_with_ddp: bool = ...
    _overlap_info: _OverlapInfo = ...
    _buckets: list[list[core.Tensor]] = ...
    ...
    def _local_step(
        self,
        gradients: list[core.Tensor | None] | None = None,
