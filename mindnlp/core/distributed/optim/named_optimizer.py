...
class _NamedOptimizer(optim.Optimizer):
    ...
    Args:
        named_parameters (Mapping[str, Union[core.Tensor, ShardedTensor]]):
    ...
    Example::
        ...
        >>> from mindnlp.core import optim
        >>> from core.distributed.optim import _NamedOptimizer
        >>>
    ...
    def __init__(
        ...
        **kwargs,
        ...
        core._C._log_api_usage_once("core.distributed.optim._NamedOptimizer")
    ...
    def step(self, closure: Optional[Callable[[], float]] = None) -> Optional[float]:
        ...
        This will call :meth:`core.optim.Optimizer.step` on the wrapped
        optimizer.
        """
        return self._optimizer.step(closure=closure)

    @property
    def state(self) -> Mapping[core.Tensor, Any]:  # type: ignore[override]
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any]) -> None:
        ...
        for idx, param_key in enumerate(self.ordered_param_keys):
            ...
            for state_key, state_val in new_state[idx].items():
                ...
                elif isinstance(state_val, core.Tensor):
    ...
    def init_state(self) -> None:
        ...
        for param in self.named_parameters.values():
            if param.requires_grad:
                t = core.zeros_like(param)
                param.grad = core.autograd.Variable(t)
