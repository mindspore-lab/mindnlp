...
from mindnlp import core.jit as jit
from mindnlp import core.nn as nn
from mindnlp.core import Tensor
from core.distributed.rpc import RRef
...
class DistributedOptimizer:
    ...
    This class uses :meth:`~core.distributed.autograd.get_gradients` in order
    to retrieve the gradients for specific parameters.

    Concurrent calls to
    :meth:`~core.distributed.optim.DistributedOptimizer.step`,
    ...
    def __init__(self, optimizer_class, params_rref, *args, **kwargs):
        core._C._log_api_usage_once("core.distributed.optim.DistributedOptimizer")
    ...
    def step(self, context_id):
        ...
        This will call :meth:`core.optim.Optimizer.step` on each worker
        ...
        corresponding :class:`~core.distributed.autograd.context` that
