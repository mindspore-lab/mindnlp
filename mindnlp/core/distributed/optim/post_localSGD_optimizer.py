...
class PostLocalSGDOptimizer(core.optim.Optimizer):
    r"""
    Wraps an arbitrary :class:`core.optim.Optimizer` and runs `post-local SGD <https://arxiv.org/abs/1808.07217>`_,
    ...
    Example::
        ...
        >>> from core.distributed.optim import PostLocalSGDOptimizer
        ...
        >>> local_optim = core.optim.SGD(params=model.parameters(), lr=0.01)
    ...
    def __init__(self, optim: core.optim.Optimizer, averager: averagers.ModelAverager):
        self.optim = optim
    ...
    def state_dict(self):
        r"""
        This is the same as :class:`core.optim.Optimizer` :meth:`state_dict`,
    ...
    def load_state_dict(self, state_dict):
        r"""
        This is the same as :class:`core.optim.Optimizer` :meth:`load_state_dict`,
