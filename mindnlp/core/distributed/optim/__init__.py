"""
:mod:`core.distributed.optim` exposes DistributedOptimizer, which takes a list
of remote parameters (:class:`~core.distributed.rpc.RRef`) and runs the
...
# DistributedOptimizer imports core.distributed.rpc names, so gate availability
# based on RPC being available.
if hasattr(core._C, "_rpc_init"):
