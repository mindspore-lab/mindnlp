...
def is_available() -> bool:
    ...
    Otherwise,
    ``core.distributed`` does not expose any other APIs. Currently,
    ``core.distributed`` is available on Linux, MacOS and Windows. Set
...
if is_available():
    ...
    sys.modules["core.distributed"].ProcessGroup = _ProcessGroupStub  # type: ignore[attr-defined]