...
from core.autograd.graph import register_multi_grad_hook
from core.nn.modules.module import (
...
class ModTracker:
    ...
    .. code-block:: python
        ...
        mod = core.nn.Linear(2, 2)

        with ModTracker() as tracker:
            # Access anything during the forward pass
            def my_linear(m1, m2, bias):
                print(f"Current modules: {tracker.parents}")
                return core.mm(m1, m2.t()) + bias
            core.nn.functional.linear = my_linear
    ...
    def _maybe_set_engine_callback(self):
        ...
        core.autograd.Variable._execution_engine.queue_callback(callback)
    ...
    def is_bw(self):
        ...
        """
        return core._C._current_graph_task_id() != -1
    ...
    def _fw_pre_hook(self, mod, input):
        ...
        tensors = [a for a in args if isinstance(a, core.Tensor) and a.requires_grad]
