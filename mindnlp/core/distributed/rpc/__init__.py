...
# if is_available() and not core._C._rpc_init():
#     raise RuntimeError("Failed to initialize core.distributed.rpc")
...
if is_available():
    ...
    from core._C._distributed_rpc import (  # noqa: F401
    ...
    def init_rpc(
        ...
        Args:
            ...
            rpc_backend_options (RpcBackendOptions, optional): The options
                ...
                subclass of :class:`~core.distributed.rpc.RpcBackendOptions`
                ...
                are available.
        """
        core._C._log_api_usage_once("core.distributed.init_rpc")
        ...
        # core.distributed.autograd.backward() would run into errors since
