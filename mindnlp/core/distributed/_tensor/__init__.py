"""
NOTICE: DTensor has moved to core.distributed.tensor
...
for submodule in submodules:
    full_module_name = f"core.distributed.tensor.{submodule}"
    sys.modules[f"core.distributed._tensor.{submodule}"] = import_module(
        full_module_name
    )

from core.distributed.tensor import (  # noqa: F401
    DeviceMesh,
    distribute_module,
    distribute_tensor,
    DTensor,
