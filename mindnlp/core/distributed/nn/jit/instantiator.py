...
from core.distributed.nn.jit.templates.remote_module_template import (
...
def get_arg_return_types_from_interface(module_interface):
    ...
    ), "Expect a TorchScript class interface decorated by @core.jit.interface."
    qualified_name = core._jit_internal._qualified_name(module_interface)
    cu = core.jit._state._python_cu
...
def instantiate_scriptable_remote_module_template(
    ...
    module_interface_cls_name = core._jit_internal._qualified_name(
    ...
    str_dict = dict(
        ...
        args=args_str,
        kwargs=kwargs_str,
        jit_script_decorator="@core.jit.script",
    )
