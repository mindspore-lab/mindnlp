...
from mindnlp import core.distributed.algorithms.model_averaging.averagers as averagers
from mindnlp import core.distributed.algorithms.model_averaging.utils as utils
...
class HierarchicalModelAverager(averagers.ModelAverager):
    ...
    This is an extension of :class:`~core.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`
    ...
    level is usually embedded in :meth:`~core.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook`.
    ...
    Args:
        ...
        process_group (ProcessGroup, optional): The overall process group containing all the processes that runs model averaging.
                                                ...
                                                by :func:`core.distributed.init_process_group`, will be used.
                                                (default: ``None``)
    ...
    Example::
        ...
        >>> from mindnlp import core
        >>> from mindnlp import core.distributed as dist
        >>> from core.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook import (
        >>>     PostLocalSGDState,
        >>>     post_localSGD_hook,
        >>> )
        >>> from mindnlp import core.distributed.algorithms.model_averaging.hierarchical_model_averager as hierarchicalSGD
    ...
    def average_parameters(
        self,
        params: Union[
            Iterable[core.nn.Parameter], Iterable[Dict[str, core.nn.Parameter]]
        ],
    ):
        """
