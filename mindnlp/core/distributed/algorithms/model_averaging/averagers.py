...
from core.utils._typing_utils import not_none as _not_none
...
class ModelAverager(ABC):
    ...
    Args:
        process_group: The process group to be used for all-reduce.
                       ...
                       is created by :func:`core.distributed.init_process_group`,
...
class PeriodicModelAverager(ModelAverager):
    ...
    by running :class:`~core.nn.DistributedDataParallel` (DDP)
    using the subgroups created by :meth:`~core.distributed.new_subgroups`.
    ...
    Example::
        ...
        >>> from mindnlp import core
        >>> from mindnlp import core.distributed as dist
        >>> from mindnlp import core.distributed.algorithms.ddp_comm_hooks.post_localSGD_hook as post_localSGD
