...
from core.distributed import group, ProcessGroup
...
def average_parameters(
    params: Iterator[core.nn.Parameter], process_group: ProcessGroup
):
    """
    ...
    flat_params = core.cat([p.data.reshape(-1) for p in params_it1])
    ...
    if core.accelerator.is_available():
        core.accelerator.synchronize()
...
def get_params_to_average(
    params: Union[Iterable[core.nn.Parameter], Iterable[Dict[str, core.nn.Parameter]]]
):
    """
