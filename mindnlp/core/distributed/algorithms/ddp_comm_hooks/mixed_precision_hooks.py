...
from core.distributed.utils import _free_storage
...
def _reducer_allreduce_and_upcast_hook(
    ...
    with core.get_device_module().stream(stream):
        fut.wait()
    ...
    def wait_for_stream_cb():
        core.accelerator.current_stream().wait_stream(stream)
