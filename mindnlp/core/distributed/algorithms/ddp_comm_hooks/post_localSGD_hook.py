...
def post_localSGD_hook(
    ...
    :class:`~core.distributed.algorithms.model_averaging.averagers.PeriodicModelAverager`)
    ...
    Example::
        ...
        >>> # Please refer to the examples in ``core.distributed.algorithms.model_averaging.averagers`` module.
    """
    global_group_to_use = (
