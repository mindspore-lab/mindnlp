...
from core.distributed.optim.zero_redundancy_optimizer import _OverlapStatus
from core.nn.parallel.distributed import DistributedDataParallel
...
def _perform_local_step(
    ...
    gradients: List[Optional[core.Tensor]] = [
...
def hook_with_zero_step(
    hook: Callable[[Any, dist.GradBucket], core.futures.Future],
    ...
    Arguments:
        hook (Callable[[Any, dist.GradBucket], core.futures.Future]): the hook
            to modify.
...
def hook_with_zero_step_interleaved(
    ...
    Arguments:
        hook (Any * dist.GradBucket -> core.futures.Future): the hook to
            modify.
        ddp (DistributedDataParallel): the :class:`DistributedDataParallel`
            instance to use.
        zero (ZeroRedundancyOptimizer): the :class:`ZeroRedundancyOptimizer`
