...
class Backend:
    ...
    def broadcast(self, tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support broadcast.")

    def allreduce(self, tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allreduce.")

    def allreduce_sparse(self, tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allreduce sparse.")

    def allreduce_coalesced(self, tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allreduce_coalesced.")

    def reduce(self, tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support reduce.")

    def allgather(self, output_tensors: List[List[core.Tensor]], input_tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allgather.")

    def _allgather_base(self, output_buffer: core.Tensor, input_buffer: core.Tensor, opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support _allgather_base.")

    def allgather_coalesced(self, output_tensor_lists: List[List[core.Tensor]], input_tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allgather_coalesced.")

    def allgather_into_tensor_coalesced(self, outputs: List[core.Tensor], inputs: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support allgather_into_tensor_coalesced.")

    def gather(self, output_tensors: List[List[core.Tensor]], input_tensors: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support gather.")

    def scatter(self, output_tensors: List[core.Tensor], input_tensors: List[List[core.Tensor]], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support scatter.")

    def reduce_scatter(self, output_tensors: List[core.Tensor], input_tensors: List[List[core.Tensor]], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support reduce_scatter.")

    def _reduce_scatter_base(self, output_buffer: core.Tensor, input_buffer: core.Tensor, opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support _reduce_scatter_base.")

    def reduce_scatter_tensor_coalesced(self, outputs: List[core.Tensor], inputs: List[core.Tensor], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support reduce_scatter_tensor_coalesced.")

    def alltoall_base(self, output_buffer: core.Tensor, input_buffer: core.Tensor, output_split_sizes: List[int], input_split_sizes: List[int], opts: Optional[Any] = None):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support alltoall_base.")

    def alltoall(self, output_tensors: List[core.Tensor], input_tensors: List[core.Tensor], opts: Optional[Any] = None):
    ...
    def send(self, tensors: List[core.Tensor], dst_rank: int, tag: int):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support send.")

    def recv(self, tensors: List[core.Tensor], src_rank: int, tag: int):
        raise NotImplementedError(f"Backend {self.get_backend_name()} does not support recv.")

    def recv_anysource(self, tensors: List[core.Tensor], tag: int):
    ...
    def get_bound_device_id(self) -> Optional[core.device]:
        return self.bound_device_id_

    def eager_connect_single_device(self, device: core.device):
        pass

    def set_bound_device_id(self, device: Optional[core.device]):
        if device:
