...
from core.distributed._composable.contract import contract
from core.distributed._composable_state import _get_module_state, _insert_module_state
from core.distributed.fsdp._common_utils import _FSDPState
from core.distributed.fsdp._dynamo_utils import _annotate_modules_for_dynamo
from core.distributed.fsdp._init_utils import (
    _init_buffer_state,
    _init_core_state,
    _init_device_handle,
...
from core.distributed.fsdp._runtime_utils import (
    _register_post_forward_hook,
    _register_pre_forward_hook,
    _register_root_pre_forward_hook,
)
from core.distributed.fsdp._state_dict_utils import _register_all_state_dict_hooks
from core.distributed.fsdp._wrap_utils import _auto_wrap
from core.distributed.fsdp.api import (
    BackwardPrefetch,
    CPUOffload,
    MixedPrecision,
    ShardingStrategy,
)
from core.distributed.fsdp.wrap import _Policy


@contract(state_cls=_FSDPState)
@deprecated(
    "`core.distributed._composable.fully_shard` is being deprecated. "
    ...
    "`core.distributed._composable.fully_shard` will be removed after PyTorch 2.5. "
    "If you are looking for FSDP2, please see `core.distributed._composable.fsdp.fully_shard.`",
...
def fully_shard(
    ...
    *,
    ...
    ignored_modules: Optional[Iterable[core.nn.Module]] = None,
    device_id: Optional[Union[int, core.device]] = None,
    param_init_fn: Optional[Callable[[nn.Module], None]] = None,
    sync_module_states: bool = False,
    forward_prefetch: bool = False,
    ignored_states: Union[
        Optional[Iterable[core.nn.Parameter]], Optional[Iterable[core.nn.Module]]
    ] = None,
) -> nn.Module:
    """Applies ``FullyShardedDataParallel`` (FSDP) semantics to ``module``."""
    core._C._log_api_usage_once("core.distributed.fully_shard")
