...
class MixedPrecisionPolicy:
    ...
    Attributes:
        param_dtype (Optional[core.dtype]): This specifies the dtype for
            ...
            ``None``)
        reduce_dtype (Optional[core.dtype]): This specifies the dtype for
            ...
            (Default: ``None``)
        output_dtype (Optional[core.dtype]): This specifies the dtype for
    ...
    param_dtype: Optional[core.dtype] = None
    reduce_dtype: Optional[core.dtype] = None
    output_dtype: Optional[core.dtype] = None
