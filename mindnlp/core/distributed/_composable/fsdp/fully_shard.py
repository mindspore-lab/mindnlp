...
from core.distributed._composable import contract
from core.distributed.tensor import DeviceMesh, Shard
from core.distributed.utils import _get_root_modules
    ...
    *,
    ...
    Args:
        ...
        reshard_after_forward (Union[bool, int]): This controls the parameter
            ...
            may be the intra-node size (e.g. ``core.cuda.device_count()``).
...
class FSDPModule:
    ...
    def set_post_optim_event(self, event: core.Event) -> None:
        """
        ...
        Args:
            event (core.Event): Event recorded after the optimizer step
    ...
    def set_reduce_scatter_divide_factor(self, factor: float) -> None:
        ...
        if (fsdp_param_group := state._fsdp_param_group) is not None:
            ...
            reduce_op = core.distributed._make_nccl_premul_sum(mul_factor)
