...
from mindnlp import core.distributed.checkpoint.state_dict_loader as loader
from mindnlp import core.distributed.checkpoint.state_dict_saver as saver
...
class _Checkpointer:
    ...
    provided by :py:mod:`core.distributed.checkpoint.storage`, essentially calling
    :py:meth: `core.distributed.state_dict_saver.save` and
    :py:meth: `core.distributed.state_dict_loader.load` with the provided storage
    readers and writers.
    ...
    def save(
        ...
        """Calls :py:meth: `core.distributed.state_dict_saver.save`. Utilizing values passed during initialization."""
        return saver.save(
            state_dict,
            self.storage_writer,
    ...
    def async_save(
        ...
        """
        Calls :py:meth: `core.distributed.state_dict_saver._async_save`. Utilizing values passed during initialization.
    ...
    def load(self, state_dict: Dict[str, Any]) -> None:
        """Calls :py:meth: `core.distributed.state_dict_loader.load`. Utilizing values passed during initialization."""
        loader.load(
            state_dict,
