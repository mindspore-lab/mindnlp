...
from core.distributed._shard.sharded_tensor import Shard, ShardedTensor, ShardMetadata
...
if TYPE_CHECKING:
    from core.distributed._shard.sharded_tensor.metadata import ShardedTensorMetadata
