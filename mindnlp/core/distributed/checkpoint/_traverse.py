...
from core.distributed.checkpoint.metadata import STATE_DICT_TYPE
...
def _keep_visiting_tensors(value: STATE_DICT_ITEM) -> bool:
    return isinstance(value, core.Tensor)
...
def traverse_state_dict_v_2_3(
    ...
    By default, all collections with at least one ``core.Tensor`` element are traversed.
