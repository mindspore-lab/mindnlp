...
from core.distributed.checkpoint.stateful import StatefulT
...
class TensorProperties:
    ...
    dtype: core.dtype = field(default_factory=core.get_default_dtype)
...
class MetadataIndex:
    ...
    offset: Optional[core.Size] = None
    ...
    def __init__(
        ...
        if offset is not None:
            object.__setattr__(self, "offset", core.Size(offset))
