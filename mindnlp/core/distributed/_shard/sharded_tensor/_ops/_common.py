...
from core.distributed._shard.common_op_utils import _basic_validation
...
def _sharded_op_common(op, early_stop_func, extra_check):
    ...
    Return:
        func (Callable): Torch function for which we want to provide a sharded
            implementation (ex: core.transpose)
    """
...
def _register_sharded_op_on_local_shards(
    ...
    ``core.nn.functional.gelu`` or ``core.nn.functional.relu``.
