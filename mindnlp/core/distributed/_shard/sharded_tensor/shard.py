...
class Shard:
    ...
    Args:
        tensor(core.Tensor): Local tensor for the shard.
        metadata(:class `core.distributed._shard.sharded_tensor.ShardMetadata`):
    ...
    def from_tensor_and_offsets(
        cls, tensor: core.Tensor, shard_offsets: List[int], rank: int
    ):
        """
        Creates a Shard of a ShardedTensor from a local core.Tensor, shard_offsets and rank.
