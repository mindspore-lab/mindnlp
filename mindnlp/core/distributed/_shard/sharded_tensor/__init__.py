...
from core.distributed._shard.op_registry_utils import _decorator_func
...
if TYPE_CHECKING:
    from core.distributed._shard.sharding_spec import ShardingSpec
else:
...
def full(
    ...
    *,
    ...
    Args:
        sharding_spec (:class:`core.distributed._sharding_spec.ShardingSpec`): The specification
            describing how to shard the Tensor.
        size (int...):  a list, tuple, or `core.Size` of integers defining the shape of the
            output tensor.
    ...
    core.nn.init.constant_(sharded_tensor, fill_value)  # type: ignore[arg-type]
...
def rand(
    ...
    *size,
    ...
    core.nn.init.uniform_(sharded_tensor, 0, 1)  # type: ignore[arg-type]
    return sharded_tensor
...
def randn(
    ...
    *size,
    ...
    core.nn.init.normal_(sharded_tensor, 0, 1)  # type: ignore[arg-type]
    return sharded_tensor
...
def init_from_local_shards(
    ...
    Args:
        local_shards (List[:class `core.distributed._shard.sharded_tensor.Shard`]): A list
            of shards that represent the local shards on this rank.
        global_size (int...):  a list, tuple, or `core.Size` of integers defining the
    ...
    Examples:
        ...
        >>> )
        >>> local_shards = [Shard(core.randn(5, 5), local_shard_metadata)]
...
def state_dict_hook(module, destination, prefix, local_metadata):
    ...
    :meth:`core.nn.Module._register_state_dict_hook`.
    """
...
def custom_sharded_op_impl(func):
    ...
    Args:
        func(Callable): Torch function for which we want to provide a sharded
            implementation (ex: core.nn.functional.linear)
    """
