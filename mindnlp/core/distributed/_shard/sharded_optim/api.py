...
class ShardedOptimizer(optim.Optimizer):
    def __init__(
        ...
        **optimizer_kwargs,
        ...
        Args:
            ...
            optimizer_class (core.optim.Optimizer): the Optimizer to use
                locally, i.e. core.optim.SGD, core.optim.Adagrad, etc.
    ...
    def zero_grad(self, set_to_none: bool = True):  # type: ignore[override]
        r"""Resets the gradients of all optimized :class:`core.Tensor` s.
    ...
    def state_dict(self) -> Dict[str, Any]:
        ...
        instead of parameter indices like core.optim.Optimizer.
