...
from core.distributed._shard.sharder import Sharder
...
class ShardingPlan:
    ...
    Args:
        plan (Dict[str, Union[:class:`core.distributed._shard.sharding_spec.ShardingSpec`,
              :class:`core.distributed._shard.sharder.Sharder`]):
            a dict describes how to shard a module, there're currently two ways to shard a module:
                ...
                2. shard a submodule by applying a `Sharder` on it, keyed by the name of a module
                   to a `Sharder` object.
        output_plan (Dict[str, :class:`core.distributed._shard.sharding_spec.ShardingSpec`), optional):
...
class ShardingPlanner(abc.ABC):
    ...
    def build_plan(self, module: nn.Module) -> ShardingPlan:
        ...
        Args:
            module (:class:`core.nn.Module`):
                The module to apply sharding to.
        Returns:
            A :class:`core.distributed._shard.sharding_plan.ShardingPlan` object that
