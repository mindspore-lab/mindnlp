...
from mindnlp.core.nn import _reduction as _Reduction
from mindnlp.core.testing._internal.common_utils import TestCase, to_gpu, freeze_rng_state, is_iterable, \
    gradcheck, gradgradcheck, set_default_dtype, skipIfTorchDynamo, TEST_WITH_ROCM
from mindnlp.core.testing._internal.common_cuda import TEST_CUDA, SM90OrLater
# from mindnlp.core.autograd.gradcheck import _get_numerical_jacobian, _iter_tensors
# from mindnlp.core.autograd import Variable
from mindnlp.core.types import _TensorOrTensors
...
#    `(10, 8)` to `core.nn.Linear` constructor, then we should pass `core::nn::LinearOptions(10, 8)`
#    as the corresponding C++ constructor argument to `core::nn::Linear`.
...
#    `core.nn.FractionalMaxPool2d(2, output_ratio=0.5, _random_samples=random_samples)`,
#    the corresponding C++ constructor argument is
#    `core::nn::FractionalMaxPool2dOptions(2).output_ratio(0.5)._random_samples(random_samples)`,
...
#    "F::InterpolateFuncOptions().size(std::vector<int64_t>({12})).scale_factor(std::nullopt).mode(core::kNearest)".
...
#    "F::poisson_nll_loss(i, t.to(i.options()), F::PoissonNLLLossFuncOptions().reduction(core::kNone))".
...
module_tests = [
    dict(
        ...
        cpp_constructor_args='core::nn::LinearOptions(10, 8)',
        input_size=(4, 10),
        reference_fn=lambda i, p, _: core.mm(i, p[0].t()) + p[1].view(1, -1).expand(4, 8),
        with_tf32=True,
        tf32_precision=0.005,
        default_dtype=core.double,
    ),
    dict(
        module_name='Linear',
        constructor_args=(10, 8, False),
        cpp_constructor_args='core::nn::LinearOptions(10, 8).bias(false)',
        input_size=(4, 10),
        desc='no_bias',
        reference_fn=lambda i, p, _: core.mm(i, p[0].t()),
        with_tf32=True,
    ...
    dict(
        ...
        cpp_constructor_args='core::nn::RReLUOptions().lower(0.1).upper(0.9)',
        input_size=(4, 4, 5),
        desc='with_up_down',
        test_cuda=False,
        default_dtype=core.double,
    ...
    dict(
        module_name='Flatten',
        input_size=(2, 3, 4, 5),
        reference_fn=lambda i, *_: core.flatten(i, 1),
        default_dtype=core.double,
    ),
    ...
    dict(
        ...
        cpp_constructor_args='core::nn::CrossMapLRN2dOptions(5).alpha(5e-3).beta(1e-3).k(2)',
        input_size=(2, 3, 6, 6),
...
def _rand_tensor_non_equal(*size):
    ...
    return core.randperm(total).view(*size).double()
...
def poissonnllloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='F::poisson_nll_loss('
                          'i, t.to(i.options()), F::PoissonNLLLossFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.rand(10, 10),
...
def bceloss_no_reduce_test():
    t = Variable(core.randn(15, 10).gt(0).to(core.double))
    return dict(
        ...
        cpp_function_call='F::binary_cross_entropy('
                          'i, t.to(i.options()), F::BinaryCrossEntropyFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.rand(15, 10).clamp_(2.8e-2, 1 - 2.8e-2),
        cpp_var_map={'i': '_get_input()', 't': t},
...
def bceloss_no_reduce_scalar_test():
    t = core.randn(()).gt(0).to(core.double)
    return dict(
        ...
        cpp_function_call='F::binary_cross_entropy('
                          'i, t.to(i.options()), F::BinaryCrossEntropyFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.rand(()).clamp_(2.8e-2, 1 - 2.8e-2),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_: -(t * i.log() + (1 - t) * (1 - i).log()),
        pickle=False,
        default_dtype=core.double)
...
def bceloss_weights_no_reduce_test():
    t = Variable(core.randn(15, 10, dtype=core.double).gt(0).to(core.double))
    weights = core.rand(10, dtype=core.double)
    return dict(
        ...
        cpp_function_call='F::binary_cross_entropy('
                          'i, t.to(i.options()), '
                          'F::BinaryCrossEntropyFuncOptions().weight(weights.to(i.options())).reduction(core::kNone))',
        input_fn=lambda: core.rand(15, 10).clamp_(2.8e-2, 1 - 2.8e-2),
...
def bceloss_weights_no_reduce_scalar_test():
    t = core.randn(()).gt(0).to(core.double)
    weights = core.rand((), dtype=core.double)
    return dict(
...
def bce_with_logistic_legacy_enum_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::binary_cross_entropy_with_logits(
            i, t.to(i.options()), F::BinaryCrossEntropyWithLogitsFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.rand(15, 10).clamp_(2.8e-2, 1 - 2.8e-2),
        cpp_var_map={'i': '_get_input()', 't': t},
...
def kldivloss_with_target_no_reduce_test():
    t = core.rand(10, 10, dtype=core.double)
    return dict(
        fullname='KLDivLoss_with_target_no_reduce',
        constructor=wrap_functional(
            lambda i: F.kl_div(i, t.type_as(i), reduction='none')),
        cpp_function_call='F::kl_div(i, t.to(i.options()), F::KLDivFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.rand(10, 10).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
...
def kldivloss_no_reduce_scalar_test():
    t = core.rand((), dtype=core.double)
    return dict(
        fullname='KLDivLoss_no_reduce_scalar',
        constructor=wrap_functional(
            lambda i: F.kl_div(i, t.type_as(i), reduction='none')),
        cpp_function_call='F::kl_div(i, t.to(i.options()), F::KLDivFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.rand(()).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
            loss_reference_fns['KLDivLoss'](i, t.type_as(i), reduction='none'),
        supports_forward_ad=True,
...
def kldivloss_with_log_target_no_reduce_test():
    t = core.rand(10, 10, dtype=core.double).log()
    return dict(
        fullname='KLDivLoss_with_log_target_no_reduce',
        constructor=wrap_functional(
            lambda i: F.kl_div(i, t.type_as(i), reduction='none', log_target=True)),
        cpp_function_call='F::kl_div(i, t.to(i.options()), F::KLDivFuncOptions().reduction(core::kNone).log_target(true))',
        input_fn=lambda: core.rand(10, 10).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def kldivloss_no_reduce_scalar_log_target_test():
    t = core.rand((), dtype=core.double).log()
    return dict(
...
def l1loss_no_reduce_test():
    t = core.randn(2, 3, 4, dtype=core.double)
    return dict(
        fullname='L1Loss_no_reduce',
        constructor=wrap_functional(
            lambda i: F.l1_loss(i, t.type_as(i), reduction='none')),
        cpp_function_call='F::l1_loss(i, t.to(i.options()), F::L1LossFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.randn(2, 3, 4),
        cpp_var_map={'i': '_get_input()', 't': t},
...
def l1loss_no_reduce_complex_test():
    t = core.randn(2, 3, 4, dtype=core.cdouble)
    return dict(
        fullname='L1Loss_no_reduce_complex',
        constructor=wrap_functional(
            lambda i: F.l1_loss(i, t.type_as(i), reduction='none')),
        cpp_function_call='F::l1_loss(i, t.to(i.options()), F::L1LossFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.randn(2, 3, 4, dtype=core.cdouble),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_: (i - t.type_as(i)).abs(),
        supports_forward_ad=True,
        pickle=False)
...
def l1loss_no_reduce_scalar_test():
    t = core.randn((), dtype=core.double)
    return dict(
        fullname='L1Loss_no_reduce_scalar',
        constructor=wrap_functional(
            lambda i: F.l1_loss(i, t.type_as(i), reduction='none')),
        cpp_function_call='F::l1_loss(i, t.to(i.options()), F::L1LossFuncOptions().reduction(core::kNone))',
        input_fn=lambda: core.randn(()),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_: (i - t.type_as(i)).abs(),
        supports_forward_ad=True,
        pickle=False,
...
def mseloss_no_reduce_test():
    input_size = (2, 3, 4, 5)
    target = core.randn(*input_size, dtype=core.double)
    return dict(
        fullname='MSELoss_no_reduce',
        constructor=wrap_functional(
            lambda i: F.mse_loss(i, target.type_as(i), reduction='none')),
        cpp_function_call='F::mse_loss(i, target.to(i.options()), F::MSELossFuncOptions().reduction(core::kNone))',
...
def nllloss_no_reduce_test():
    t = Variable(core.empty(15).uniform_().mul(10).floor().long())
    ...
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong), F::NLLLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.rand(15, 10).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def nllloss_no_reduce_ignore_index_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong), F::NLLLossFuncOptions().ignore_index(2).reduction(core::kNone))''',
        input_fn=lambda: core.rand(15, 10).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
            loss_reference_fns['NLLLoss'](i, t.type_as(i).long(), **kwargs),
...
def nllloss_no_reduce_weights_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong),
            F::NLLLossFuncOptions().weight(weight.to(i.options())).reduction(core::kNone))''',
        input_fn=lambda: core.rand(15, 10).add(1e-2).log(),
...
def nllloss_no_reduce_weights_ignore_index_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong),
            F::NLLLossFuncOptions().weight(weight.to(i.options())).reduction(core::kNone).ignore_index(2))''',
        input_fn=lambda: core.rand(15, 10).add(1e-2).log(),
        cpp_var_map={'i': '_get_input()', 't': t, 'weight': weight},
        reference_fn=lambda i, *_:
            loss_reference_fns['NLLLoss'](i, t.type_as(i).long(), **kwargs(i)),
...
def nllloss_no_reduce_weights_ignore_index_neg_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong),
            F::NLLLossFuncOptions().weight(weight.to(i.options())).reduction(core::kNone).ignore_index(-1))''',
        input=core.rand(15, 10, dtype=core.double).add(1e-2).log(),
        cpp_var_map={'i': '_get_input()', 't': t, 'weight': weight},
        reference_fn=lambda i, *_:
            loss_reference_fns['NLLLoss'](i, t.type_as(i).long(), **kwargs(i)),
        pickle=False,
...
def nllloss2d_no_reduce_test():
    t = Variable(core.rand(2, 5, 5).mul(3).floor().long())
    kwargs = {'reduction': 'none'}
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong), F::NLLLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.rand(2, 3, 5, 5).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
    ...
    return dict(
        ...
        constructor=wrap_functional(
            lambda i: F.nll_loss(i, t.type_as(i).long(), ignore_index=int(kwargs['ignore_index']),
                                 reduction=str(kwargs['reduction']))),
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong), F::NLLLossFuncOptions().ignore_index(1).reduction(core::kNone))''',
        input_fn=lambda: core.rand(2, 3, 5, 5).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
            loss_reference_fns['NLLLossNd'](i, t.type_as(i).long(), **kwargs),
...
def nlllossNd_no_reduce_test():
    t = Variable(core.rand(2, 5, 5, 2, 2).mul(3).floor().long())
    kwargs = {'reduction': 'none'}
    return dict(
        ...
        cpp_function_call='''F::nll_loss(
            i, t.to(i.options()).to(core::kLong), F::NLLLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.rand(2, 3, 5, 5, 2, 2).log(),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
            loss_reference_fns['NLLLossNd'](i, t.type_as(i).long(), **kwargs),
        pickle=False,
...
def smoothl1loss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(2, 3, 4),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def smoothl1loss_beta_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(core::kNone), 0.5)''',
        input_fn=lambda: core.randn(2, 3, 4),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def smoothl1loss_zero_beta_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(core::kNone), 0)''',
        input_fn=lambda: core.randn(2, 3, 4),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def huberloss_delta_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::huber_loss(
            i, t.to(i.options()), F::HuberLossFuncOptions().reduction(core::kNone).delta(0.5))''',
        input_fn=lambda: core.randn(2, 3, 4),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multilabelmarginloss_0d_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multilabel_margin_loss(
            i, t.to(i.options()).to(core::kLong), F::MultilabelMarginLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(()),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multilabelmarginloss_1d_no_reduce_test():
    t = Variable(core.rand(10).mul(10).floor().long())
    return dict(
...
def multilabelmarginloss_index_neg_test():
    t = Variable(core.clamp(core.rand(5, 10).add(-.5).mul(20).floor().long(), min=-1))
    return dict(
        ...
        cpp_function_call='''F::multilabel_margin_loss(
            i, t.to(i.options()).to(core::kLong), F::MultilabelMarginLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
            loss_reference_fns['MultiLabelMarginLoss'](i, t.data.type_as(i).long(), reduction='none'),
        check_sum_reduction=True,
...
def multilabelmarginloss_no_reduce_test():
    t = Variable(core.rand(5, 10).mul(10).floor().long())
    return dict(
...
def hingeembeddingloss_no_reduce_test():
    t = Variable(core.randn(10).gt(0).to(core.double).mul_(2).sub(1))
    return dict(
        ...
        cpp_function_call='''F::hinge_embedding_loss(
            i, t.to(i.options()), F::HingeEmbeddingLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def hingeembeddingloss_margin_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::hinge_embedding_loss(
            i, t.to(i.options()), F::HingeEmbeddingLossFuncOptions().margin(0.5).reduction(core::kNone))''',
        input_fn=lambda: core.randn(10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def softmarginloss_no_reduce_test():
    t = core.randn(5, 5, dtype=core.double)
    return dict(
        ...
        cpp_function_call='''F::soft_margin_loss(
            i, t.to(i.options()), F::SoftMarginLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 5),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multilabelsoftmarginloss_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multilabel_soft_margin_loss(
            i, t.to(i.options()), F::MultilabelSoftMarginLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multilabelsoftmarginloss_weights_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multilabel_soft_margin_loss(
            i, t.to(i.options()),
            F::MultilabelSoftMarginLossFuncOptions().weight(weights.to(i.options())).reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t, 'weights': weights},
        reference_fn=lambda i, *_:
...
def multimarginloss_no_reduce_test():
    t = core.rand(5).mul(8).floor().long()
    return dict(
        ...
        cpp_function_call='''F::multi_margin_loss(
            i, t.to(i.options()).to(core::kLong), F::MultiMarginLossFuncOptions().reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multimarginloss_1d_no_reduce_test():
    t = core.rand(1).mul(8).floor().long()
    return dict(
...
def multimarginloss_p_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multi_margin_loss(
            i, t.to(i.options()).to(core::kLong), F::MultiMarginLossFuncOptions().p(2).reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10).clamp_(1e-2, 1 - 1e-2),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multimarginloss_margin_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multi_margin_loss(
            i, t.to(i.options()).to(core::kLong),
            F::MultiMarginLossFuncOptions().margin(0.5).reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t},
        reference_fn=lambda i, *_:
...
def multimarginloss_weights_no_reduce_test():
    ...
    return dict(
        ...
        cpp_function_call='''F::multi_margin_loss(
            i, t.to(i.options()).to(core::kLong),
            F::MultiMarginLossFuncOptions().weight(weights.to(i.options())).reduction(core::kNone))''',
        input_fn=lambda: core.randn(5, 10),
        cpp_var_map={'i': '_get_input()', 't': t, 'weights': weights},
        reference_fn=lambda i, *_:
            loss_reference_fns['MultiMarginLoss'](i, t.data.type_as(i).long(),
...
def single_batch_reference_fn(input, parameters, module):
    ...
    single_batch_input = [single_batch_input] if isinstance(single_batch_input, core.Tensor) else single_batch_input
...
def get_new_module_tests():
    new_module_tests = [
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3)',
            input_size=(2, 4, 10),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).stride(2)',
            input_size=(2, 4, 10),
            cudnn=True,
            desc='stride',
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).stride(1).padding(1)',
            input_size=(2, 4, 10),
            cudnn=True,
            desc='pad1',
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 5).stride(1).padding(2)',
            input_size=(2, 4, 10),
            cudnn=True,
            desc='pad2',
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 4, 3).stride(1).padding(1)',
            input_size=(1, 4, 1),
            cudnn=True,
            desc='pad1size1',
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 4, 5).stride(1).padding(2)',
            input_size=(1, 4, 1),
            cudnn=True,
            desc='pad2size1',
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).dilation(2)',
            input_size=(2, 4, 10),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 6, 3).groups(2)',
            input_size=(2, 4, 6),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).padding(core::kValid)',
            input_size=(2, 4, 10),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).padding(core::kSame)',
            input_size=(2, 4, 10),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 4).padding(core::kSame)',
            input_size=(2, 4, 10),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv1dOptions(4, 5, 3).padding(core::kSame).dilation(2)',
            input_size=(2, 4, 10),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::ConvTranspose1dOptions(3, 4, 3).stride(3).padding(1).output_padding(1)',
            cudnn=True,
            input_size=(1, 3, 7),
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::ConvTranspose1dOptions(3, 4, 3)
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::ConvTranspose1dOptions(4, 6, 3)
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(3, 4, {3, 2})',
            input_size=(2, 3, 7, 5),
            cudnn=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(3, 4, {3, 3}).stride({2, 2})',
            input_size=(2, 3, 6, 6),
            cudnn=True,
            desc='strided',
            check_with_long_tensor=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(3, 4, {3, 3}).stride({2, 2}).padding({1, 1})',
            input_size=(2, 3, 6, 6),
            cudnn=True,
            desc='padding',
            check_with_long_tensor=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(3, 2, {3, 3}).stride({2, 2}).padding({1, 1}).dilation({2, 2})',
            input_size=(2, 3, 8, 8),
            cudnn=True,
            desc='dilated',
            check_with_long_tensor=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 6, {3, 2}).groups(2)',
            input_size=(2, 4, 6, 5),
            cudnn=True,
            check_with_long_tensor=True,
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(2, 4, {3, 4}).padding(core::kValid)',
            input_size=(2, 2, 6, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(2, 4, {3, 4}).padding(core::kSame)',
            input_size=(2, 2, 6, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(2, 4, {3, 4}).padding(core::kSame).dilation(2)',
            input_size=(2, 2, 6, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::ConvTranspose2dOptions(3, 4, 3)
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::ConvTranspose2dOptions(2, 4, {2, 3}).groups(2)',
            input_size=(1, 2, 4, 5),
            cudnn=True,
            check_with_long_tensor=True,
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 4, {3, 3}).groups(4)',
            input_size=(2, 4, 6, 6),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 8, {3, 3}).groups(4)',
            input_size=(2, 4, 6, 6),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 4, {3, 3}).stride({2, 2}).groups(4)',
            input_size=(2, 4, 6, 6),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 4, {3, 3}).padding({1, 1}).groups(4)',
            input_size=(2, 4, 6, 6),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv2dOptions(4, 4, {2, 2}).dilation({2, 2}).groups(4)',
            input_size=(2, 4, 5, 5),
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(2, 3, {2, 3, 2})',
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::Conv3dOptions(2, 3, {2, 3, 4})
                                    .stride(1).padding(0).dilation(1).groups(1).bias(false)''',
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, 2).stride(2)',
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, 2).stride(2).padding(1)',
            input_size=(2, 3, 5, 5, 5),
            cudnn=True,
            desc='stride_padding',
            check_with_long_tensor=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, {2, 3, 4})',
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(2, 4, 3).groups(2)',
            input_size=(1, 2, 4, 5, 4),
            cudnn=True,
            check_with_long_tensor=True,
            with_tf32=True,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, 2).dilation(2)',
            input_size=(2, 3, 5, 5, 5),
            with_tf32=True,
            tf32_precision=0.05,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, 2).dilation(2).stride(2)',
            input_size=(2, 3, 5, 5, 5),
            with_tf32=True,
            tf32_precision=0.05,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, {2, 3, 4}).padding(core::kValid)',
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, {2, 3, 4}).padding(core::kSame)',
            input_size=(2, 3, 6, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.05,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::Conv3dOptions(3, 4, {2, 3, 4}).padding(core::kSame).dilation(2)',
            input_size=(2, 3, 6, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.05,
        ...
        dict(
            ...
            constructor_args=(2, 3, (2, 3, 2)),
            cpp_constructor_args='core::nn::ConvTranspose3dOptions(2, 3, {2, 3, 2})',
            cudnn=True,
            input_size=(1, 2, 4, 5, 4),
            with_tf32=True,
            tf32_precision=0.05,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::ReplicationPad3dOptions({1, 2, 3, 3, 2, 1})',
        ...
        dict(
            ...
            constructor_args=((1, 2, 3, 3, 2, 1),),
            cpp_constructor_args='core::nn::ReplicationPad3dOptions({1, 2, 3, 3, 2, 1})',
            input_fn=lambda: core.rand(2, 3, 2, 2, 2, dtype=core.complex128, requires_grad=True),
            skip_half=True,
            desc='complex'
        ),
        dict(
            ...
            cpp_constructor_args='core::nn::EmbeddingOptions(4, 3)',
            input_fn=lambda: core.empty(2, 3, dtype=core.long).random_(4),
            check_gradgrad=False,
            default_dtype=core.double,
            decorator=skipIfTorchDynamo("https://github.com/pycore/pycore/issues/117971")
        ),
        dict(
            module_name='Embedding',
            constructor_args=(4, 3),
            cpp_constructor_args='core::nn::EmbeddingOptions(4, 3)',
            input_fn=lambda: core.empty(1, 512, dtype=core.long).random_(4).expand(7, 512),
            check_gradgrad=False,
            desc='discontiguous',
            default_dtype=core.double,
            decorator=skipIfTorchDynamo("https://github.com/pycore/pycore/issues/117971")
        ...
        dict(
            ...
            constructor_args=(4, 3),
            cpp_constructor_args='core::nn::EmbeddingBagOptions(4, 3)',
            input_fn=lambda: core.empty(2, 3, dtype=core.long).random_(4),
            check_gradgrad=False,
            desc='mean',
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::EmbeddingBagOptions(4, 3)
                                    .max_norm(std::nullopt).norm_type(2.).scale_grad_by_freq(false).mode(core::kSum)''',
            input_fn=lambda: core.empty(2, 3, dtype=core.long).random_(4),
            check_gradgrad=False,
            desc='sum',
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::EmbeddingBagOptions(4, 3)
                                    .max_norm(std::nullopt).norm_type(2.).scale_grad_by_freq(false).mode(core::kMax)''',
            input_fn=lambda: core.empty(2, 3, dtype=core.long).random_(4),
            check_gradgrad=False,
            desc='max',
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::EmbeddingBagOptions(4, 3).padding_idx(1)',
            input_fn=lambda: core.stack([core.randperm(3), core.randperm(3)]),
            check_gradgrad=False,
            default_dtype=core.double,
        ),
        dict(
            ...
            cpp_constructor_args='''core::nn::EmbeddingBagOptions(4, 3)
                                    .max_norm(std::nullopt).norm_type(2.).scale_grad_by_freq(false).mode(core::kSum).padding_idx(1)''',
            input_fn=lambda: core.stack([core.randperm(3), core.randperm(3)]),
            check_gradgrad=False,
            default_dtype=core.double,
        ),
        dict(
            ...
            cpp_constructor_args='''core::nn::EmbeddingBagOptions(4, 3)
                                    .max_norm(std::nullopt).norm_type(2.).scale_grad_by_freq(false).mode(core::kMax).padding_idx(1)''',
            input_fn=lambda: core.stack([core.randperm(3), core.randperm(3)]),
            check_gradgrad=False,
            default_dtype=core.double,
        ),
        dict(
            ...
            constructor=lambda: nn.EmbeddingBag(4, 3, sparse=True, dtype=core.double),
            cpp_constructor_args='''core::nn::EmbeddingBagOptions(4, 3)
                                    .sparse(true)._weight(core::rand({4, 3}).to(core::kFloat64))''',
            input_fn=lambda: core.randperm(2).repeat(1, 2),
            check_gradgrad=False,
            has_sparse_gradients=True,
        ),
        dict(
            constructor=lambda: nn.Embedding(4, 3, dtype=core.double, sparse=True),
            cpp_constructor_args='core::nn::EmbeddingOptions(4, 3).sparse(true)._weight(core::rand({4, 3}).to(core::kFloat64))',
            input_fn=lambda: core.randperm(2).repeat(1, 2),
        ...
        dict(
            ...
            constructor_args=(3,),
            cpp_constructor_args='core::nn::PixelShuffleOptions(3)',
            input_size=(1, 9, 4, 4),
            default_dtype=core.double,
        ),
        dict(
            ...
            constructor_args=(3,),
            cpp_constructor_args='core::nn::PixelUnshuffleOptions(3)',
        ...
        dict(
            ...
            cpp_options_args='''F::InterpolateFuncOptions()
                                .size(std::vector<int64_t>({12})).scale_factor(std::nullopt).mode(core::kNearest)''',
            input_size=(1, 2, 4),
        ...
        dict(
            ...
            cpp_options_args='''F::InterpolateFuncOptions()
                                .size(std::nullopt).scale_factor(std::vector<double>({4.})).mode(core::kNearest)''',
            input_size=(1, 2, 4),
        ...
        dict(
            ...
            # See https://github.com/pycore/pycore/issues/5006
            precision=3e-4,
            pickle=False,
            default_dtype=core.double,
        ),
        ...
        dict(
            constructor=wrap_functional(F.softmax, dim=1, dtype=core.float64),
            cpp_options_args='F::SoftmaxFuncOptions(1).dtype(core::kFloat64)',
            input_size=(2, 128),
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::UnfoldOptions({2, 2}).dilation({1, 1}).padding({0, 0}).stride({1, 1})',
            input_size=(2, 4, 3, 3),
            check_gradgrad=False,
            test_cuda=True,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::FoldOptions({3, 3}, {2, 2}).dilation({1, 1}).padding({0, 0}).stride({1, 1})',
            input_size=(2, 16, 4),
            check_gradgrad=False,
            test_cuda=True,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::UnfoldOptions(2).dilation(1).padding(0).stride(1)',
            input_size=(2, 4, 3, 3),
            check_gradgrad=False,
            test_cuda=True,
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::FoldOptions(3, 2).dilation(1).padding(0).stride(1)',
            input_size=(2, 16, 4),
            check_gradgrad=False,
            test_cuda=True,
            default_dtype=core.double,
        ...
        dict(
            ...
            input_fn=lambda: (core.randn(10, 8), core.randn(10, 8)),
            default_dtype=core.double,
        ),
        dict(
            module_name='PairwiseDistance',
            input_fn=lambda: (core.randn(10, 1), core.randn(10, 8)),
            desc='broadcast_lhs',
            default_dtype=core.double,
        ),
        dict(
            module_name='PairwiseDistance',
            input_fn=lambda: (core.randn(10, 8), core.randn(1, 8)),
            desc='broadcast_rhs',
            default_dtype=core.double,
        ),
        dict(
            ...
            cpp_constructor_args='core::nn::PairwiseDistanceOptions().p(1.5).eps(1e-05).keepdim(true)',
            input_fn=lambda: (core.randn(10, 8), core.randn(10, 8)),
        ...
        dict(
            module_name='PairwiseDistance',
            input_fn=lambda: (core.randn(8), core.randn(8)),
            reference_fn=single_batch_reference_fn,
            desc='no_batch_dim',
            default_dtype=core.double,
        ),
        dict(
            ...
            cpp_constructor_args='''core::nn::TransformerEncoderLayerOptions(4, 2)
                                    .dim_feedforward(16)
                                    .dropout(0.0)''',
            input_size=(2, 3, 4),
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::TransformerDecoderLayerOptions(4, 2)
                                    .dim_feedforward(8)
                                    .dropout(0.0)''',
            input_fn=lambda: (core.rand(3, 3, 4), core.rand(2, 3, 4)),
            check_gradgrad=False,
            desc='relu_activation',
            with_tf32=True,
            tf32_precision=0.05,
        ...
        dict(
            ...
            cpp_constructor_args='''core::nn::TransformerOptions()
                                    .d_model(4)
                                    .nhead(2)
                                    ...
                                    .dim_feedforward(8)
                                    .dropout(0.0)
                                    .activation(core::kReLU)''',
            input_fn=lambda: (core.rand(3, 3, 4), core.rand(2, 3, 4), core.rand(3, 3)),
            check_gradgrad=False,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::LinearOptions(3, 5)',
            input_fn=lambda: core.rand(3),
            reference_fn=lambda i, p, _: core.mm(i.view(1, -1), p[0].t()).view(-1) + p[1],
            desc="no_batch_dim",
            with_tf32=True,
            tf32_precision=0.005,
            default_dtype=core.double,
        ...
        dict(
            module_name='Flatten',
            cpp_constructor_args='core::nn::FlattenOptions().start_dim(-3).end_dim(-1)',
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::UnflattenOptions(-2, {2, 2})',
            constructor_args=(-2, core.Size([2, 2])),
            input_size=(3, 4, 5),
            reference_fn=single_batch_reference_fn,
            desc="no_batch_dim",
            default_dtype=core.double,
        ...
        dict(
            ...
            cpp_constructor_args='core::nn::LayerNormOptions({56, 56, 56}).eps(1e-5).elementwise_affine(false)',
    ...
    for padding_mode, cpp_padding_mode in zip(
            ...
            ['core::kReflect', 'core::kCircular', 'core::kReplicate', 'core::kZeros']):
        # conv signature:
        ...
        for d in (1, 2, 3):
            if d == 3 and padding_mode == 'reflect':
                ...
                #        https://github.com/pycore/pycore/issues/27655
                continue
            ...
            new_module_tests.append(
                dict(
                    ...
                    cpp_constructor_args=f'''core::nn::Conv{d}dOptions(2, 3, 3)
                                            .stride(2)
                                            .padding({cpp_padding})
                                            .dilation(1)
                                            .groups(1)
    ...
    non_linear_activations_extra_info: dict[str, dict] = {
        'CELU': {'constructor_args': (2.,), 'default_dtype': core.double},
        'Threshold': {'constructor_args': (2., 1.)},
        'Hardsigmoid': {'check_gradgrad': False, 'check_jit': False, 'default_dtype': core.double},
        'Hardswish': {'check_gradgrad': False, 'check_jit': False, 'default_dtype': core.double},
        # For RRelu, test that compare CPU and GPU results fail because RNG
        # is different between CPU and GPU
        'RReLU': {'test_cuda': False, 'default_dtype': core.double},
        'ELU': {'default_dtype': core.double},
        'GELU': {'default_dtype': core.double},
        'GLU': {'default_dtype': core.double},
        'Hardshrink': {'default_dtype': core.double},
        'Hardtanh': {'default_dtype': core.double},
        'LeakyReLU': {'default_dtype': core.double},
        'LogSigmoid': {'default_dtype': core.double},
        'Mish': {'default_dtype': core.double},
        'PReLU': {'default_dtype': core.double},
        'ReLU6': {'default_dtype': core.double},
        'ReLU': {'default_dtype': core.double},
        'SELU': {'default_dtype': core.double},
        'SiLU': {'default_dtype': core.double},
        'Sigmoid': {'default_dtype': core.double},
        'Softplus': {'default_dtype': core.double},
        'Softshrink': {'default_dtype': core.double},
        'Softsign': {'default_dtype': core.double},
        'Tanh': {'default_dtype': core.double},
        'Tanhshrink': {'default_dtype': core.double},
    }
...
def kldivloss_reference(input, target, reduction='mean', log_target=False):
    if log_target:
        result = core.exp(target) * (target - input)
    else:
...
def nlllossNd_reference(input, target, weight=None, ignore_index=-100,
    ...
    output = core.zeros(out_size).type_as(input)

    if weight is None:
        weight = core.ones(C).type_as(input)
    total_weight = 0
...
def cross_entropy_loss_prob_target_reference(input, target, weight=None, reduction='mean',
    ...
    input = core.log_softmax(input, 1)
    C = input.size(1)
    if weight is None:
        weight = core.ones(C).type_as(input)
...
def cross_entropy_loss_indices_target_reference(input, target, weight=None, ignore_index=-100,
    ...
    log_softmax_input = core.log_softmax(input, 1)
    nllloss = F.nll_loss(
        log_softmax_input,
        target,
        weight,
    ...
    if reduction == 'mean':
        if weight is not None:
            ...
            ret = core.sum(smooth_loss) / weight.gather(0, target.masked_select(ignore_mask.logical_not()).flatten()).sum()
        else:
            ret = core.mean(smooth_loss.masked_select(ignore_mask.logical_not()))
    elif reduction == 'sum':
        ret = core.sum(smooth_loss)
    else:
        ret = smooth_loss
...
def hingeembeddingloss_reference(input, target, margin=1.0, reduction='mean'):
    ...
    output = core.where(target == 1, input, margin_clamp)
...
def cosineembeddingloss_reference(input1, input2, target, margin=0, reduction='mean'):
    ...
    output = core.where(target == 1, 1 - _cos(input1, input2), (_cos(input1, input2) - margin).clamp(min=0))
...
def tripletmarginloss_reference(anchor, positive, negative, margin=1.0, p=2, eps=1e-6, swap=False,
                                reduction='mean'):
    d_p = core.pairwise_distance(anchor, positive, p, eps)
    d_n = core.pairwise_distance(anchor, negative, p, eps)
    if swap:
        d_s = core.pairwise_distance(positive, negative, p, eps)
        d_n = core.min(d_n, d_s)

    output = core.clamp(margin + d_p - d_n, min=0.0)
    if reduction == 'mean':
        return output.mean()
    elif reduction == 'sum':
        return output.sum()
...
def ctcloss_reference(log_probs, targets, input_lengths, target_lengths, blank=0, reduction='mean'):
    input_lengths = core.as_tensor(input_lengths, dtype=core.long)
    target_lengths = core.as_tensor(target_lengths, dtype=core.long)
    dt = log_probs.dtype
    ...
    for i in range(log_probs.size(1)):
        ...
        for t in range(1, input_length):
            ...
            alpha_next[2:] += core.where(mask_third, alpha[:-2], alpha.new_zeros(1))
            alpha = probs[t, targets_prime] * alpha_next
        losses.append(-alpha[-2:].sum().log()[None])
    output = core.cat(losses, 0)
    if reduction == 'mean':
...
for reduction in reductions:
    regression_test_info = dict(
        ...
        input_fn=lambda: core.rand((3,)).log(),
        target_fn=lambda: core.rand((3,)),
        reference_fn=single_batch_reference_criterion_fn,
        test_cpp_api_parity=False,
        default_dtype=core.double,
    )
...
classification_criterion_no_batch = [
    (
        'BCELoss',
        lambda: core.sigmoid(core.randn(9, dtype=core.double)),
        lambda: core.randn(9, dtype=core.double).gt(0).to(core.double)
    ),
    ('BCEWithLogitsLoss', lambda: core.randn(9, dtype=core.double), lambda: core.randn(9, dtype=core.double)),
    ('HingeEmbeddingLoss', lambda: core.randn(9, dtype=core.double), lambda: core.tensor([-1, 1, 1] * 3)),
    ('MultiLabelMarginLoss', lambda: core.randn(4, dtype=core.double), lambda: core.tensor([3, 0, -1, 1])),
    ('SoftMarginLoss', lambda: core.randn(9, dtype=core.double), lambda: core.tensor([-1, 1, 1] * 3)),
    ('NLLLoss', lambda: F.log_softmax(core.randn(3, dtype=core.double), dim=0), lambda: core.tensor(1)),
    (
        'CosineEmbeddingLoss',
        lambda: (core.randn(9, dtype=core.double), core.randn(9, dtype=core.double)),
        lambda: core.tensor(1, dtype=core.double)
    ),
    # For MarginRankingLoss, input_fn : (x1, x2) and target_fn : target
    ('MarginRankingLoss', lambda: (core.randn(()), core.randn(())), lambda: core.randn(()).sign()),
    # For TripletMarginLoss, input_fn : (anchor, positive) and target_fn : negative
    (
        'TripletMarginLoss',
        lambda: (core.randn(9, dtype=core.double), core.randn(9, dtype=core.double)),
        lambda: core.randn(9, dtype=core.double)
    ),
    ('MultiLabelSoftMarginLoss', lambda: core.randn(9, dtype=core.double), lambda: core.randn(9)),
]
...
class NNTestCase(TestCase):
    ...
    def _backward(self, module: nn.Module,
                  input: _TensorOrTensors, output: core.Tensor,
                  grad_output: Union[core.Tensor, Sequence[core.Tensor]],
    ...
    def _jacobian(self, input, num_out):
        if isinstance(input, tuple):
            ...
            return core.zeros(input.nelement(), num_out)
    ...
    def _analytical_jacobian(self, module, input: _TensorOrTensors, jacobian_input=True, jacobian_parameters=True):
        ...
        if jacobian_parameters:
            ...
            jacobian_param = core.zeros(num_param, output_size)

        for i in range(output_size):
            param, d_param = self._get_parameters(module)
            # make non grad zeros
            d_param = [core.zeros_like(p) if d is None else d for (p, d) in zip(param, d_param)]

            d_out = core.zeros_like(output)
            ...
            if jacobian_parameters:
                jacobian_param[:, i] = core.cat(self._flatten_tensors(d_param), 0)

        res: tuple[core.Tensor, ...] = ()
        if jacobian_input:
            res += jacobian_inp,
        if jacobian_parameters:
            res += jacobian_param,
        ...
        if name not in self._arg_cache:
            ...
            if name in self._extra_kwargs:
                ...
                def map_tensor_sizes(sizes):
                    ...
                    elif isinstance(sizes, core.Tensor):
                        return sizes.double()
                    else:
                        return core.randn(sizes)
...
class ModuleTest(TestBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.default_dtype is None:
            self.default_dtype = core.get_default_dtype()
    ...
    def __call__(self, test_case):
        with set_default_dtype(self.default_dtype):
            ...
            if self.should_test_pickle:
                # TODO: do this with in-memory files as soon as core.save will support it
                with tempfile.TemporaryFile() as f:
                    test_case._forward(module, input)
                    core.save(module, f)
                    f.seek(0)
                    # weights_only=False as this is legacy code that saves the model
                    module_copy = core.load(f, weights_only=False)
    ...
    def noncontiguize(self, obj):
        ...
        for d in range(ndim):
            if tensor.size(d) > 1:
                dim = d + 1
                break
        noncontig = core.stack([core.empty_like(tensor), tensor], dim).select(dim, 1).detach()
    ...
    def test_noncontig(self, test_case, module, input):
        ...
        if isinstance(input, core.Tensor) and input.dim() == 0:
            return
        if any(i.dim() == 0 for i in input if isinstance(i, core.Tensor)):
            return
    ...
    def test_cuda(self, test_case):
        ...
        with set_default_dtype(self.default_dtype):
            ...
            type_map = {core.double: core.float}
            cpu_input_tuple = cpu_input if isinstance(cpu_input, tuple) else (cpu_input,)

            is_any_input_complex = any(isinstance(t, core.Tensor) and t.dtype.is_complex for t in cpu_input_tuple)
            ...
            if self.check_gradgrad and not self.FIXME_no_cuda_gradgrad_comparison:
                ...
                # core.autograd.grad doesn't complain that some inputs
...
class NewModuleTest(InputVariableMixin, ModuleTest):  # type: ignore[misc]
    ...
    def _check_gradients(self, test_case, module, input_tuple):
        ...
        if self.has_sparse_gradients:
            assert num_inputs == 1
            test_input_jacobian = core.is_floating_point(input_tuple[0])
    ...
    def _do_test(self, test_case, module, input):
        ...
        if all(isinstance(t, core.LongTensor) for t in input_tuple) and TEST_CUDA:
            # check that cuda() moves module parameters to correct GPU device,
            # and that float() casts parameters correctly
            input_tuple = tuple(t.cuda() for t in input_tuple)
            module.float().cuda()
            module(*input_tuple)
            assert_module_parameters_are(core.cuda.FloatTensor, 0)  # type: ignore[attr-defined]

            if core.cuda.device_count() > 1:
                input_tuple = tuple(t.cuda(1) for t in input_tuple)
                module.cuda(1)
                with core.cuda.device(1):
                    module(*input_tuple)
                assert_module_parameters_are(core.cuda.FloatTensor, 1)  # type: ignore[attr-defined]
        else:
            ...
            def to_half(x):
                # TODO: core.complex32 when properly supported
                return to_type(x, core.float16, None)

            def to_single(x):
                return to_type(x, core.float32, core.complex64)

            def to_double(x):
                return to_type(x, core.float64, core.complex128)

            # to float
            input_tuple = tuple(to_single(t) for t in input_tuple)
            module.float()
            module(*input_tuple)
            assert_module_parameters_are(core.FloatTensor)

            # and back to double
            input_tuple = tuple(to_double(t) for t in input_tuple)
            module.double()
            module(*input_tuple)
            assert_module_parameters_are(core.DoubleTensor)
            ...
            if TEST_CUDA and self.should_test_cuda:
                ...
                if self.cudnn:
                    with core.backends.cudnn.flags(enabled=False):
                        module(*input_tuple)
                        assert_module_parameters_are(core.cuda.FloatTensor, 0)  # type: ignore[attr-defined]

                if core.cuda.device_count() >= 2:
                ...
                if not self.skip_double:
                    ...
                    module.double().cuda()
                    module(*input_tuple)
                    assert_module_parameters_are(core.cuda.DoubleTensor, 0)  # type: ignore[attr-defined]
                ...
                if not self.skip_half:
                    ...
                    module.half().cuda()
                    module(*input_tuple)
                    assert_module_parameters_are(core.cuda.HalfTensor, 0)  # type: ignore[attr-defined]
        core.set_num_threads(num_threads)
...
class CriterionTest(InputVariableMixin, TestBase):  # type: ignore[misc]
    ...
    def test_cuda(self, test_case, dtype, extra_args=None):
        ...
        with set_default_dtype(self.default_dtype):
            ...
            # core.HalfTensor doesn't support most operations, converting back to default
            if dtype in {core.half, core.bfloat16}:
                cpu_input = self._get_input()
                cpu_target = self._get_target()
            ...
            test_case.assertEqual(cpu_output, gpu_output,
                                  atol=1e-1 if dtype in {core.half, core.bfloat16} else 4e-4, rtol=0, exact_dtype=False)
...
def _test_bfloat16_ops(test_case, op, device, inp_dims=(), prec=1e-2, scale_factor=None):
    # fp32 compute
    input1 = core.randn(inp_dims, dtype=core.float32, device=device, requires_grad=True)
    if scale_factor is not None:
        input1 = (core.rand(inp_dims, dtype=core.bfloat16, device=device) * scale_factor).float().requires_grad_()
    out1 = op(input1)
    grad_input1 = core.randn_like(out1, device=device)
...
def _test_module_empty_input(test_case, module, inp, check_size=True, inference=False):
    ...
    if not inference:
        for p in module.parameters():
            if p.requires_grad:
                test_case.assertEqual(p.grad, core.zeros_like(p.grad))
        test_case.assertEqual(inp.grad, core.zeros_like(inp))
...
def _create_basic_net():
    class Layer(nn.Module):
        def __init__(self) -> None:
            super().__init__()
            self.layer_dummy_param = nn.Parameter(core.empty(3, 5))
            self.layer_dummy_buf = nn.Buffer(core.zeros(1, 3, 3, 7))

    class Net(nn.Module):
        def __init__(self) -> None:
            super().__init__()
            self.l1 = Layer()
            self.dummy_param = nn.Parameter(core.empty(3, 5))
            self.dummy_buf = nn.Buffer(core.zeros(7, 3, 3, 1))
