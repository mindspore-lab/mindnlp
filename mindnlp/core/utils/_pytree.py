    ...
    *,
    ...
    Args:
        ...
        from_dumpable_context: An optional keyword argument to custom specify how
            ...
            which is being used in core.export right now.
...
@deprecated(
    "`core.utils._pytree._register_pytree_node` is deprecated. "
    "Please use `core.utils._pytree.register_pytree_node` instead.",
