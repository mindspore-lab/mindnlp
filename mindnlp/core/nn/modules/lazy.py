...
class LazyModuleMixin:
    ...
    :class:`core.nn.UninitializedParameter` s that should not be accessed
    or used, and afterward they contain regular :class:`core.nn.Parameter` s.
    ...
    >>> # xdoctest: +SKIP
    >>> class LazyMLP(core.nn.Module):
    ...     def __init__(self) -> None:
    ...         super().__init__()
    ...         self.fc1 = core.nn.LazyLinear(10)
    ...         self.relu1 = core.nn.ReLU()
    ...         self.fc2 = core.nn.LazyLinear(1)
    ...         self.relu2 = core.nn.ReLU()
    ...
    ...
    >>> optim = core.optim.SGD(lazy_mlp.parameters(), lr=0.01)
    ...
    For example, if the LazyMLP class defined above had a :class:`core.nn.LazyLinear` module
    first and then a regular :class:`core.nn.Linear` second, the second module would be
    ...
    Lazy modules can load regular :class:`core.nn.Parameter` s (i.e. you can serialize/deserialize
    initialized LazyModules and they will remain initialized)


    >>> full_mlp = LazyMLP()
    >>> # Dry run to initialize another module
    >>> full_mlp.forward(core.ones(10, 1))
    ...
    def _lazy_load_hook(
        ...
        module instance.
        See comment in ``core.nn.Module._register_load_state_dict_pre_hook``
    ...
    def _infer_parameters(self: _LazyProtocol, module, args, kwargs=None):
        ...
        using :class:`core.nn.parameter.ParameterMode.Infer`, runs a forward pass
