...
from mindspore.common.initializer import initializer, XavierUniform, XavierNormal
...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        if not self._qkv_same_embed_dim:
            self.q_proj_weight = Parameter(initializer(XavierUniform(), (embed_dim, embed_dim)))
            self.k_proj_weight = Parameter(initializer(XavierUniform(), (embed_dim, self.kdim)))
            self.v_proj_weight = Parameter(initializer(XavierUniform(), (embed_dim, self.vdim)))
