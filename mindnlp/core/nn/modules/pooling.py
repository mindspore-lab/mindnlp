...
class MaxPool1d(_MaxPoolNd):
    ...
    Args:
        ...
        return_indices: If ``True``, will return the argmax along with the max values.
                        Useful for :class:`core.nn.MaxUnpool1d` later
...
class MaxPool2d(_MaxPoolNd):
    ...
    Args:
        ...
        return_indices: if ``True``, will return the max indices along with the outputs.
                        Useful for :class:`core.nn.MaxUnpool2d` later
...
class MaxPool3d(_MaxPoolNd):
    ...
    Args:
        ...
        dilation: a parameter that controls the stride of elements in the window
        return_indices: if ``True``, will return the max indices along with the outputs.
                        Useful for :class:`core.nn.MaxUnpool3d` later
        ceil_mode: when True, will use `ceil` instead of `floor` to compute the output shape
    ...
    Examples::
        ...
        >>> input = core.randn(20, 16, 50, 44, 31)
        >>> output = m(input)
...
class AdaptiveAvgPool2d(_AdaptiveAvgPoolNd):
    ...
    Examples:
        ...
        >>> input = core.randn(1, 64, 8, 9)
        >>> output = m(input)
        >>> # target output size of 7x7 (square)
        >>> m = nn.AdaptiveAvgPool2d(7)
        >>> input = core.randn(1, 64, 10, 9)
        >>> output = m(input)
