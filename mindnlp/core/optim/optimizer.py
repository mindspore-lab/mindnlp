...
class Optimizer:
    ...
    Args:
        params (iterable): an iterable of :class:`core.Tensor` s or
    ...
    def _optimizer_step_code(self) -> None:
        """Entry point for `core.profile.profiler`.
    ...
    def register_state_dict_pre_hook(
        ...
        r"""Register a state dict pre-hook which will be called before :meth:`~core.optim.Optimizer.state_dict` is called.
        ...
        Returns:
            :class:`core.utils.hooks.RemoveableHandle`:
                a handle that can be used to remove the added hook by calling
                ``handle.remove()``
        """
    ...
    def register_state_dict_post_hook(
        ...
        r"""Register a state dict post-hook which will be called after :meth:`~core.optim.Optimizer.state_dict` is called.
    ...
    def state_dict(self) -> StateDict:
        ...
        * ``param_groups``: a List containing all parameter groups where each
        ...
        packed_state = {
            (param_mappings[id(k)] if isinstance(k, core.Tensor) else k): v
    ...
    def register_load_state_dict_pre_hook(
        ...
        :meth:`~core.optim.Optimizer.load_state_dict` is called. It should have the
        following signature::
