        ...
        if isinstance(pretrained_model_name_or_path, str):
            ...
            if is_resuming_training:
                if is_sharded:
                    ...
                    state_dict = loading_func(filename \
                        if not use_safe else safe_filename, **load_kwargs)
        ...
        # sharded
            ...
            if os.path.exists(index_filename):
                ...
                try:
                    ...
                    logging.warning(
                        f"A {type(pretrained_model)} \
                            model is loaded from '{pretrained_model_name_or_path}', "
...
##################################-Done-############################################################
    ...
    def add_and_load_reward_modeling_adapter(
        ...
        loading_func = safe_load_file \
            # if safe_loading else torch.load
