...
class HFcmrc2018():
    """
    Hugging Face cmrc2018 dataset source
    """
    ...
    def _load(self):
        for every_dict in self.dataset_list:
            ...
            self._s_idex.append(every_dict['answers']['answer_start'][0])
...
def HF_CMRC2018(
    ...
    r"""
    Load the huggingface CMRC2018 dataset
    ...
    Examples:
        ...
        >>> dataset_train, dataset_validation, dataset_test  = HF_CMRC2018(root, split)
    ...
    for _, file in enumerate(ds_list):
        dataset = GeneratorDataset(source=HFcmrc2018(file),
                                   column_names=[
...
@process.register
def HF_CMRC2018_Process(dataset, char_vocab, word_vocab=None,
    ...
    Examples:
        ...
        >>> dataset_test = HF_CMRC2018(split='test')
        >>> CMRC2018_test = HF_CMRC2018_Process(dataset=dataset_test, char_vocab=char_vocab)
        >>> CMRC2018_test = CMRC2018_test.create_tuple_iterator()
        >>> print(next(CMRC2018_test))
    """
