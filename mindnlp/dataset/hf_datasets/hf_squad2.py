...
def HF_SQuAD2(
    ...
    Examples:
        ...
        >>> dataset_train, dataset_validation = HF_SQuAD2(root, split, shuffle=False)
...
@process.register
def HF_SQuAD2_Process(dataset, tokenizer, vocab, batch_size=64, max_context_len=1000, max_qa_len=30,
                      bucket_boundaries=None, drop_remainder=False):
    """
    the process of the SQuAD2 dataset

    Args:
        dataset (GeneratorDataset): SQuAD2 dataset.
    ...
    Examples:
        >>> dataset_train = HF_SQuAD2(split = ('train',))
        ...
        >>> squad2_train = HF_SQuAD2_Process(dataset_train, tokenizer=tokenizer, vocab=vocab, \
