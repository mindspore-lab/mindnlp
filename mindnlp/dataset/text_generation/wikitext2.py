...
@process.register
def WikiText2_Process(dataset, column = 'text', tokenizer = text.BasicTokenizer(), vocab=None):
    '''
    a function transforms specific language column in WikiText2 dataset into tensors

    Args:
        dataset (GeneratorDataset|ZipDataset): WikiText2 dataset
        column (str): The language column name in WikiText2, defaults to 'text'
