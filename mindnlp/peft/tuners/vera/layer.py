...
class VeraLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        self.vera_lambda_b[adapter_name] = nn.Parameter(ops.ones(self.out_features), requires_grad=True)
        self.vera_lambda_d[adapter_name] = nn.Parameter(ops.randn(r), requires_grad=True)
