...
CONFIG_ARCHIVE_MAP = {
    "openbmb/cpm-bee-1b": "https://huggingface.co/openbmb/cpm-bee-1b/blob/main/config.json",
    "openbmb/cpm-bee-2b": "https://huggingface.co/openbmb/cpm-bee-2b/blob/main/config.json",
    "openbmb/cpm-bee-5b": "https://huggingface.co/openbmb/cpm-bee-5b/blob/main/config.json",
...
class CpmBeeConfig(PreTrainedConfig):
    ...
    with the defaults will yield a similar configuration to that of the CPMAnt architecture.
    ...
    def __init__(
        ...
        position_bias_num_segment_buckets: int = 256,
