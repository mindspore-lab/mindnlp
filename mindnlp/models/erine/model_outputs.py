...
from .erine_utils import adapt_stale_fwd_patch
...
nn.TransformerEncoderLayer.construct = _transformer_encoder_layer_fwd
nn.TransformerDecoderLayer.construct = _transformer_decoder_layer_fwd
nn.TransformerEncoder.construct = _transformer_encoder_fwd
nn.TransformerDecoder.construct = _transformer_decoder_fwd

_encoder_init = nn.TransformerEncoder.__init__
_decoder_init = nn.TransformerDecoder.__init__
nn.TransformerEncoder.__init__ = layer_init_wrapper(_encoder_init)
nn.TransformerDecoder.__init__ = layer_init_wrapper(_decoder_init)
...
nn.TransformerEncoderLayer.__setattr__ = functools.wraps(nn.TransformerEncoderLayer.__setattr__)(
    _get_wrap_setattr(nn.TransformerEncoderLayer)
)
nn.TransformerEncoder.__setattr__ = functools.wraps(nn.TransformerEncoder.__setattr__)(
    _get_wrap_setattr(nn.TransformerEncoder)
)
nn.TransformerDecoder.__setattr__ = functools.wraps(nn.TransformerDecoder.__setattr__)(
    _get_wrap_setattr(nn.TransformerDecoder)
)
