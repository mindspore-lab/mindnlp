...
class IterableDataset(Dataset[T_co], Iterable[T_co]):
    ...
    from link: https://pytorch.org/docs/stable/_modules/torch/utils/data/dataset.html#IterableDataset
...
class DataCollatorForCompletionOnlyLM(DataCollatorForLanguageModeling):
    ...
    def mindspore_call(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        batch = super().mindspore_call(examples)
    ...
    def __iter__(self):
        ...
        while more_examples:
            ...
            for example in examples:
                self.current_size += 1
                yield {
                    "input_ids": ms.Tensor(example),
                    "labels": ms.Tensor(example),
                }
