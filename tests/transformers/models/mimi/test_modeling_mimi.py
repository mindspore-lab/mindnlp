...
from mindnlp.transformers import AutoFeatureExtractor, MimiConfig,is_mindspore_available
...
class MimiModelTester:
    ...
    def create_and_check_model_forward(self, config, inputs_dict):
        model = MimiModel(config=config).set_train(False)
...
class MimiModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def test_identity_shortcut(self):
        ...
        atols = {
            ...
            ("cuda", False, mindspore.float32): 1e-6,
            ("cuda", False, mindspore.bfloat16): 1e-2,
            ("cuda", False, mindspore.float16): 5e-3,
            ("cuda", True, mindspore.float32): 1e-6,
            ("cuda", True, mindspore.bfloat16): 1e-2,
            ("cuda", True, mindspore.float16): 5e-3,
        }
        rtols = {
            ...
            ("cpu", True, mindspore.bfloat16): 1e-2,
            ("cuda", False, mindspore.float32): 1e-4,
            ("cuda", False, mindspore.bfloat16): 1e-2,
            ("cuda", False, mindspore.float16): 5e-3,
            ("cuda", True, mindspore.float32): 1e-4,
            ("cuda", True, mindspore.bfloat16): 3e-2,
            ("cuda", True, mindspore.float16): 5e-3,
        }
                                ...
                                if not use_mask:
                                    ...
                                    if dummy_attention_mask is None:
                                        ...
                                        dummy_attention_mask = (
                                            ops.ones(batch_size, seqlen).to(mindspore.int64)
                                        )
