...
from mindnlp.utils.testing_utils import (require_sentencepiece,require_mindspore, require_vision, slow,
                                         is_vision_available, is_mindspore_available)

from ...test_modeling_common import floats_tensor, ids_tensor, random_attention_mask
from ..bart.test_modeling_bart import BartModelTester
from ..bert.test_modeling_bert import BertModelTester
from ..layoutlmv2.test_modeling_layoutlmv2 import LayoutLMv2ModelTester
...
class EncoderDecoderMixin:
    ...
    def test_training_gradient_checkpointing(self):
        ...
        model_inputs = {
            ...
            "labels": inputs_dict["labels"].astype(mindspore.int32),
...
class ViT2GPT2ModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_coco_en(self):
        ...
        def generate_step(pixel_values):
            ...
            return preds, outputs.sequences_scores.numpy()
