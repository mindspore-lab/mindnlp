...
class GroupViTVisionModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        pixel_values = floats_tensor(
            [self.batch_size, self.num_channels, self.image_size, self.image_size], rng=rng)
    ...
    def create_and_check_model(self, config, pixel_values):
        ...
        self.parent.assertEqual(
            result.last_hidden_state.shape, (self.batch_size,
                                             self.num_output_groups[-1], self.hidden_size)
        )
        self.parent.assertEqual(
...
class GroupViTVisionModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (GroupViTVisionModel,
    ...
    def test_attention_outputs(self):
        ...
        for model_class in self.all_model_classes:
            ...
            self.assertEqual(len(attentions), sum(
                g > 0 for g in self.model_tester.num_group_tokens))
...
class GroupViTTextModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (
        GroupViTTextModel,) if is_mindspore_available() else ()
    test_pruning = False
    test_head_masking = False
...
class GroupViTModelTester:
    def __init__(self, parent, text_kwargs=None, vision_kwargs=None, is_training=True):
        ...
        self.vision_model_tester = GroupViTVisionModelTester(
    ...
    def create_and_check_model(self, config, input_ids, attention_mask, pixel_values):
        ...
        self.parent.assertEqual(
            result.logits_per_text.shape, (self.text_model_tester.batch_size,
...
class GroupViTModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {
        "feature-extraction": GroupViTModel} if is_mindspore_available() else {}
    test_head_masking = False
    test_pruning = False
    test_resize_embeddings = False
    ...
    def check_pt_tf_outputs(self, tf_outputs, pt_outputs, model_class, tol=2e-5, name="outputs", attributes=None):
        super().check_pt_tf_outputs(tf_outputs, pt_outputs,
                                    model_class, tol=tol, name=name, attributes=attributes)
...
class GroupViTModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference(self):
        ...
        expected_logits = ms.Tensor([[13.3523, 6.3629]])
