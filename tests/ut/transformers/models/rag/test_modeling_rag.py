...
def require_retrieval(test_case):
    ...
    if not (is_mindspore_available()):
        test_case = unittest.skip(reason="test requires Mindspore")(test_case)
    return test_case
...
class RagModelIntegrationTests(unittest.TestCase):
    ...
    def test_rag_sequence_inference(self):
        ...
        rag_decoder_tokenizer = BartTokenizer.from_pretrained("facebook/bart-large-cnn",from_pt=True )
        rag_question_encoder_tokenizer = DPRQuestionEncoderTokenizer.from_pretrained(
            "facebook/dpr-question_encoder-single-nq-base",from_pt=True 
        )
    ...
    def test_rag_sequence_generate_batch(self):
        tokenizer = RagTokenizer.from_pretrained("facebook/rag-sequence-nq",from_pt=True )
        retriever = RagRetriever.from_pretrained(
            "facebook/rag-sequence-nq", index_name="exact", use_dummy_dataset=True, dataset_revision="b24a417",from_pt=True 
        )
        rag_sequence = RagSequenceForGeneration.from_pretrained("facebook/rag-sequence-nq", retriever=retriever,from_pt=True )
    ...
    def test_rag_sequence_generate_batch_from_context_input_ids(self):
        ...
        retriever = RagRetriever.from_pretrained(
            ...
            index_name="exact",
            use_dummy_dataset=True,
            dataset_revision="b24a417",from_pt=True 
        )
        rag_sequence = RagSequenceForGeneration.from_pretrained("facebook/rag-sequence-nq", retriever=retriever,from_pt=True )
    ...
    def test_rag_token_generate_batch(self):
        tokenizer = RagTokenizer.from_pretrained("facebook/rag-token-nq",from_pt=True )
        retriever = RagRetriever.from_pretrained(
            "facebook/rag-token-nq", index_name="exact", use_dummy_dataset=True, dataset_revision="b24a417",from_pt=True 
        )
        rag_token = RagTokenForGeneration.from_pretrained("facebook/rag-token-nq", retriever=retriever,from_pt=True )
...
class RagModelSaveLoadTests(unittest.TestCase):
    ...
    def get_rag_config(self):
        question_encoder_config = AutoConfig.from_pretrained("facebook/dpr-question_encoder-single-nq-base",from_pt=True )
        generator_config = AutoConfig.from_pretrained("facebook/bart-large-cnn",from_pt=True )
        return RagConfig.from_question_encoder_generator_configs(
            question_encoder_config,
            generator_config,
            bos_token_id=0,
    ...
    def test_rag_sequence_from_pretrained(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dirname:
            rag_sequence = RagSequenceForGeneration.from_pretrained_question_encoder_generator(
                ...
                config=rag_config,from_pt=True 
            )
        ...
        question_encoder = AutoModel.from_pretrained("facebook/dpr-question_encoder-single-nq-base",from_pt=True )
        generator = AutoModelForSeq2SeqLM.from_pretrained("facebook/bart-large-cnn",from_pt=True )
    ...
    def test_rag_token_from_pretrained(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dirname:
            rag_token = RagTokenForGeneration.from_pretrained_question_encoder_generator(
                ...
                generator_max_length=200,from_pt=True
            )
            # check that the from pretrained methods work
