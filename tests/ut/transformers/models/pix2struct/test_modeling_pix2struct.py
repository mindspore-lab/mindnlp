...
class Pix2StructModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def test_resize_embeddings_untied(self):
        ...
        # if model cannot untie embeddings -> leave test
    ...
    def _create_and_check_torchscript(self, config, inputs_dict):
        ...
        for model_class in self.all_model_classes:
            ...
            try:
                ...
                traced_model = mindspore.jit.trace(model, (input_ids, flattened_patches))
            except RuntimeError:
...
class Pix2StructIntegrationTest(unittest.TestCase):
    ...
    def test_vqa_model(self):
        ...
        model = Pix2StructForConditionalGeneration.from_pretrained(model_id, torch_dtype=mindspore.bfloat16).to(
        ...
        inputs = processor(images=image, return_tensors="pt", text=text).to(mindspore.bfloat16)
    ...
    def test_vqa_model_batched(self):
        ...
        inputs = processor(images=images, return_tensors="pt", text=texts).to(mindspore.bfloat16)
