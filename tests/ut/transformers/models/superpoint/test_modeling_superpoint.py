...
def prepare_imgs():
    image1 = Image.open("./mindnlp/tests/fixtures/tests_samples/COCO/000000039769.png")
    image2 = Image.open("./mindnlp/tests/fixtures/tests_samples/COCO/000000004016.png")
