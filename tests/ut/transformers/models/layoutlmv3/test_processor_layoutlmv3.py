...
from mindnlp.transformers import PreTrainedTokenizer, PreTrainedTokenizerBase, PreTrainedTokenizerFast
from mindnlp.transformers.models.layoutlmv3 import LayoutLMv3Tokenizer, LayoutLMv3TokenizerFast
from mindnlp.transformers.models.layoutlmv3.tokenization_layoutlmv3 import VOCAB_FILES_NAMES
from mindnlp.utils.testing_utils import require_pytesseract, require_tokenizers, require_mindspore, slow
...
if is_pytesseract_available():
    ...
    from mindnlp.transformers import LayoutLMv3ImageProcessor, LayoutLMv3Processor
...
class LayoutLMv3ProcessorIntegrationTests(unittest.TestCase):
    ...
    def test_processor_case_1(self):
        ...
        for tokenizer in tokenizers:
            ...
            # not batched
            input_image_proc = image_processor(images[0], return_tensors="ms")
            ...
            # batched
            input_image_proc = image_processor(images, return_tensors="ms")
