...
class WavLMModelTester:
    ...
    def create_and_check_batch_inference(self, config, input_values, *args):
        ...
        attention_mask = ops.ones(input_values.shape, dtype=ms.bool_)
    ...
    def check_ctc_loss(self, config, input_values, *args):
        ...
        input_values = input_values[:3]
        attention_mask = ops.ones(input_values.shape, dtype=ms.int64)
...
class WavLMModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_base(self):
        ...
        EXPECTED_HIDDEN_STATES_SLICE = ms.tensor(
    ...
    def test_inference_speaker_verification(self):
        ...
        embeddings = ops.norm(outputs.embeddings, dim=-1)
