...
def test_roberta_tokenizer_from_pretrained():
    """test GPTTokenizer from pretrained."""
    texts = ['i make a small mistake when i\'m working! 床前明月光']
    test_dataset = GeneratorDataset(texts, 'text')

    bert_tokenizer = RobertaTokenizer.from_pretrained('roberta-base', return_token=True)
...
def test_roberta_tokenizer_add_special_tokens():
