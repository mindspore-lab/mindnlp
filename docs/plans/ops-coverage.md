...
| `aten::take` | CPU | done | - | numpy impl + meta + tests |
| `aten::take_along_dim` | CPU | done | - | numpy impl + meta + tests |
| `aten::index_select` | CPU | done | - | numpy impl + meta + tests |
| `aten::gather` | CPU | done | - | numpy impl + meta + tests |
| `aten::scatter` | CPU | done | - | numpy impl + meta + tests |
